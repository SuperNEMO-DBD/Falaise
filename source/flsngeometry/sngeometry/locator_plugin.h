...
#ifndef FLSNGEOMETRY_LOCATOR_PLUGIN_H_
#define FLSNGEOMETRY_LOCATOR_PLUGIN_H_ 1
...
namespace snemo {
  ...
  namespace geometry {
    ...
    /// \brief A geometry manager plugin with embeded SuperNEMO locators.
    ...
    private:
      ...
      locator_dict_type   _locators_;      /// Locator dictionnary
...
#endif //FLSNGEOMETRY_LOCATOR_PLUGIN_H_

// end of locator_plugin.h

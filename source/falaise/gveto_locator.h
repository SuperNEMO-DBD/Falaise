...
#ifndef FLSNGEOMETRY_GVETO_LOCATOR_H_
#define FLSNGEOMETRY_GVETO_LOCATOR_H_ 1
...
namespace snemo {
  ...
  namespace geometry {
    ...
    public:
      ...
      static const int    BOTTOM_WALL     = 0; // Bottom wall
      static const int    TOP_WALL        = 1; // Top wall
    ...
    private:
      ...
      double              _block_z_[NSIDES][NWALLS_PER_SIDE];
      double              _block_window_z_[NSIDES][NWALLS_PER_SIDE];
...
#endif // FLSNGEOMETRY_GVETO_LOCATOR_H_

// end of gveto_locator.h
/*
** Local Variables: --
** mode: c++ --
** c-file-style: "gnu" --

...
namespace snemo {
  ...
  namespace geometry {
    ...
    {
      DT_THROW_IF(! is_initialized(), std::logic_error, "Locator is not initialized !");
      DT_THROW_IF(gid_.get(_module_index_) != _module_number_,
                  std::logic_error,
                  "Invalid module number (" << gid_.get(_module_index_) << "!=" <<_module_number_ << ")!");
      return get_number_of_neighbours(gid_.get(_side_index_),
                                      gid_.get(_layer_index_),
                                      gid_.get(_row_index_),
                                      other_side_);
    }
                                       ...
                                       geomtools::vector_3d & position_) const
    {
      ...
      DT_THROW_IF(gid_.get(_module_index_) != _module_number_,
                  std::logic_error,
                  "Invalid module number (" << gid_.get(_module_index_) << "!=" <<_module_number_ << ")!");
      return get_cell_position(gid_.get(_side_index_),
                               gid_.get(_layer_index_),
                               gid_.get(_row_index_),
                               position_);
      return;
    ...
    {
      DT_THROW_IF(! is_initialized(), std::logic_error, "Locator is not initialized !");
      DT_THROW_IF(side_ != utils::SIDE_BACK && side_ != utils::SIDE_FRONT,
                  std::logic_error, "Invalid side number (" << side_ << "> 1)!");
                                        ...
                                        bool other_side_) const
    {
      ...
      DT_THROW_IF(gid_.get(_module_index_) != _module_number_,
                  std::logic_error,
                  "Invalid module number (" << gid_.get(_module_index_) << "!=" << _module_number_ << ")!");
      get_neighbours_ids(gid_.get(_side_index_),
                         gid_.get(_layer_index_),
                         gid_.get(_row_index_),
                         ids_,
                         other_side_);
    ...
    {
      DT_THROW_IF(! is_initialized(), std::logic_error, "Locator is not initialized !");
      DT_THROW_IF(side_ != utils::SIDE_BACK && side_ != utils::SIDE_FRONT, std::logic_error, "Invalid side number (" << side_ << "> 1)!");
    ...
    {
      DT_THROW_IF(! is_initialized(), std::logic_error, "Locator is not initialized !");
      DT_THROW_IF(side_ != utils::SIDE_BACK && side_ != utils::SIDE_FRONT, std::logic_error, "Invalid side number " << side_ << " !");
      size_t nbr_layers = 0;
      if (side_ == utils::SIDE_BACK) {
    ...
    void gg_locator::tree_dump(std::ostream & out_,

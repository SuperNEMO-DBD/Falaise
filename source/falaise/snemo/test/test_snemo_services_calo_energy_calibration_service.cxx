...
void test1()
{
...

  {
...

    {
      ...
      caloEnergyCalibServiceConfig.store("calibrator_type", "charge_pol1");
	...
	int omNum = 125;
	const snemo::processing::calo_energy_calibrator & calibrator
	  = caloEnergyCalibService.get_calibrator(hitTimepoint, omNum);
	...
	snemo::processing::calo_energy caloEnergy = calibrator(caloHit);

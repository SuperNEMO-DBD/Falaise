...

  {
    ...
    cpd.set_name_pattern("hit_categories")
      ...
      .add_example("Use 2 hit categories to be processed by this module:: \n"
                   ...
                   "  calo.low_threshold : real as energy = 50 keV    \n"
                   "  calo.high_threshold : real as energy = 150 keV  \n"
                   "  ...                                             \n"
                   "  # Parameters for the calorimeter regime for 'xcalo' hits: \n"
                   "  xcalo.resolution : real = 0.12                  \n"
                   "  xcalo.low_threshold : real as energy = 50 keV   \n"
                   "  xcalo.high_threshold : real as energy = 150 keV \n"
                   "  ...                                             \n"
                   "                                                  \n"
                   )
      ;

...
namespace snreco {
	...
	namespace detail {
		...
		private:
			...
			double maxDelayedHitTimeGap_ = 10.0 * CLHEP::microsecond; ///< Delayed hit cluster time window (embedded time units)
		...
		template <typename Hit>
		GeigerHitTimePartition<Hit>
		GeigerTimePartitioner::partition(const GeigerHitPtrCollection<Hit> & input)
		{
...
#endif // FALAISE_SNEMO_PROCESSING_DETAIL_GEIGERTIMEPARTITIONER_H

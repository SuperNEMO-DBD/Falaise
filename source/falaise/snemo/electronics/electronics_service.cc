...
electronics_service::electronics_service() { return; }
...
const std::string& electronics_service::get_geo_label() const { return _Geo_label_; }
...
bool electronics_service::has_geometry_manager() const { return _geometry_manager_ != nullptr; }
...
bool electronics_service::is_initialized() const { return _initialized_; }
...
void electronics_service::tree_dump(std::ostream& a_out, const std::string& a_title,

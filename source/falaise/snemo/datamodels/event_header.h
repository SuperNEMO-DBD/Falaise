...
#ifndef FALAISE_SNEMO_DATAMODEL_EVENT_HEADER_H_
#define FALAISE_SNEMO_DATAMODEL_EVENT_HEADER_H_ 1
...
namespace snemo {
    ...
    namespace datamodel {
      ...
      private:
        ...
        int16_t                     _generation_; //> Generation flag
...
//BOOST_CLASS_EXPORT_KEY2(snemo::core::model::event_header, "snemo::core::model::event_header")
BOOST_CLASS_EXPORT_KEY2(snemo::datamodel::event_header, "snemo::datamodel::event_header")

#endif // FALAISE_SNEMO_DATAMODEL_EVENT_HEADER_H_

// end of event_header.h

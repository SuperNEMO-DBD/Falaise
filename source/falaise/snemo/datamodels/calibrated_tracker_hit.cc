...
namespace snemo {
  ...
  namespace datamodel {
    ...
    bool calibrated_tracker_hit::get_trait_bit(uint32_t trait) const
    {
      return (traits_ & trait) != 0u;
    }
    ...
    {
      return get_trait_bit(peripheral);
    }

    bool calibrated_tracker_hit::is_noisy() const
    {
      return get_trait_bit(noisy);
    }

    bool calibrated_tracker_hit::is_sterile() const
    {
      return get_trait_bit(sterile);
    }

    bool calibrated_tracker_hit::is_fake() const
    {
      return get_trait_bit(fake);
    }

    void calibrated_tracker_hit::set_fake(bool is_fake)
    {
      set_trait_bit(is_fake, fake);
    }

    void calibrated_tracker_hit::set_sterile(bool is_sterile)
    {
      set_trait_bit(is_sterile, sterile);
    }
    ...
    {
      return datatools::is_valid(delayed_time_);
    }
    ...
    void calibrated_tracker_hit::set_noisy(bool is_noisy)
    {
      set_trait_bit(is_noisy, noisy);
    }
    ...
    void calibrated_tracker_hit::print_tree(std::ostream & out,

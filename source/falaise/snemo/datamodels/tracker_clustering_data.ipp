...
namespace snemo {
  ...
  namespace datamodel {
                                            ...
                                            const unsigned int /* version_ */)
    {
      ...
      ar_ & boost::serialization::make_nvp("solutions",
                                           _solutions_);
      ar_ & boost::serialization::make_nvp("default_solution",
                                           _default_solution_);
      ar_ & boost::serialization::make_nvp("auxiliaries",
                                           _auxiliaries_);
      return;
    }
...
// end of falaise/snemo/datamodels/tracker_clustering_data.ipp

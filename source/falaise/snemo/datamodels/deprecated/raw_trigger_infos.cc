...
DATATOOLS_SERIALIZATION_SERIAL_TAG_IMPLEMENTATION(raw_trigger_infos,
...
uint32_t raw_trigger_infos::get_trigger_number() const { return _trigger_number_; }

const std::bitset<3>& raw_trigger_infos::get_vtzw(int side_) const { return _VTZW_[side_]; }

std::bitset<3>& raw_trigger_infos::grab_vtzw(int side_) { return _VTZW_[side_]; }

const std::bitset<10>& raw_trigger_infos::get_ctzw(int side_) const { return _CTZW_[side_]; }

std::bitset<10>& raw_trigger_infos::grab_ctzw(int side_) { return _CTZW_[side_]; }

const std::bitset<9>& raw_trigger_infos::get_ttp(int side_, int row_) const {
  return _TTP_[side_][row_];
}

std::bitset<9>& raw_trigger_infos::grab_ttp(int side_, int row_) { return _TTP_[side_][row_]; }

raw_trigger_infos::raw_trigger_infos() { return; }
...
void raw_trigger_infos::tree_dump(std::ostream& out_, const std::string& title_,
  ...
  out_ << indent << datatools::i_tree_dumpable::tag << "Trigger primitives: " << std::endl;

...
const raw_trigger_infos& raw_data::get_raw_trigger_infos() const { return _raw_trigger_infos_; }

raw_trigger_infos& raw_data::grab_raw_trigger_infos() { return _raw_trigger_infos_; }
...
raw_data::raw_tracker_hit_col& raw_data::grab_raw_tracker_hits() { return _raw_tracker_hits_; }

const datatools::properties& raw_data::get_auxiliaries() const { return _auxiliaries_; }

datatools::properties& raw_data::grab_auxiliaries() { return _auxiliaries_; }

raw_data::raw_data() { return; }
...
void raw_data::tree_dump(std::ostream& out_, const std::string& title_, const std::string& indent_,
                         bool inherit_) const {
  std::string indent;
  if (!indent_.empty()) {
    indent = indent_;

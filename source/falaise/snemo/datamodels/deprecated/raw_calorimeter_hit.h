...
class raw_calorimeter_hit : public geomtools::base_hit {
 public:
  ...
  enum data_description_mask {
    ...
    DATA_DESC_AUX_HASTIMECFDINTERP =
        0x10,                  //!< The raw data stores the interpolated CFD timestamp [T]
  ...
  static const uint16_t TDC_MAX_SAMPLING_DEPTH =
      1024;  //!< Maximum number of samples with the SAMLONG chip

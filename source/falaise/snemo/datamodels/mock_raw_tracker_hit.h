...
namespace snemo {
  ...
  namespace datamodel {
    ...
    private:
      ...
      double  _ref_time_;          //!< Relative time of the hit in relation to the absolute timestamp of the current event
...
//BOOST_CLASS_EXPORT_KEY2(snemo::datamodel::mock_raw_tracker_hit, "snemo::datamodel::mock_raw_tracker_hit")

...
BOOST_CLASS_EXPORT_KEY2(snemo::datamodel::helix_trajectory_pattern, "snemo::datamodel::helix_trajectory_pattern")

#endif // FALAISE_SNEMO_DATAMODEL_HELIX_TRAJECTORY_PATTERN_H

// end of falaise/snemo/datamodels/helix_trajectory_pattern.h
/*
** Local Variables: --
** mode: c++ --
** c-file-style: "gnu" --

...
datatools::properties& tracker_trajectory_data::grab_auxiliaries() { return _auxiliaries_; }
...
tracker_trajectory_data::tracker_trajectory_data() { return; }
...
void tracker_trajectory_data::tree_dump(std::ostream& out_, const std::string& title_,
  ...
  out_ << indent << datatools::i_tree_dumpable::tag << "Solutions : " << _solutions_.size()
       << std::endl;

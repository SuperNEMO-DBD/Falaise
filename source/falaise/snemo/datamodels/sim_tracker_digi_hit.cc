...
namespace snemo {
  ...
  namespace datamodel {
    ...
    bool sim_tracker_digi_hit::has_anode_t0() const
    {
      return (_store & STORE_ANODE_T0);
    }

    bool sim_tracker_digi_hit::has_anode_t1() const
    {
      return (_store & STORE_ANODE_T1);
    }

    bool sim_tracker_digi_hit::has_anode_t2() const
    {
      return (_store & STORE_ANODE_T3);
    }

    bool sim_tracker_digi_hit::has_anode_t3() const
    {
      return (_store & STORE_ANODE_T3);
    }

    bool sim_tracker_digi_hit::has_anode_t4() const
    {
      return (_store & STORE_ANODE_T4);
    }

    bool sim_tracker_digi_hit::has_cathode_t5() const
    {
      return (_store & STORE_CATHODE_T5);
    }

    bool sim_tracker_digi_hit::has_cathode_t6() const
    {
      return (_store & STORE_CATHODE_T6);
    }

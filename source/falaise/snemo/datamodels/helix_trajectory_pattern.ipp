...
namespace snemo {
  ...
  namespace datamodel {
    ...
    void helix_trajectory_pattern::serialize(Archive & ar,
                                             const unsigned int /* version */)
    {
      // inherit from the 'base_trajectory_pattern' mother class:
...
// end of falaise/snemo/datamodels/helix_trajectory_pattern.ipp

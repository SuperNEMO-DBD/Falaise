...
namespace snemo {
  ...
  namespace datamodel {
    ...
    bool sim_digi_event_data::is_valid() const
    {
      return true;
    }
    ...
    sim_trigger_digi_data & sim_digi_event_data::grab_trigger_data()
    {
      return _trigger_digi_data_;
    }
    ...
    sim_readout_digi_data & sim_digi_event_data::grab_readout_data()  
    {
      return _readout_digi_data_;
    }

    const datatools::properties & sim_digi_event_data::get_auxiliaries() const
    {
      return _auxiliaries_;
    }

    datatools::properties & sim_digi_event_data::grab_auxiliaries()
    {
      return _auxiliaries_;
    }

    void sim_digi_event_data::tree_dump(std::ostream & out_,

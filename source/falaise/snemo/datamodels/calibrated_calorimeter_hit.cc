...
namespace snemo {
  ...
  namespace datamodel {
    ...
    double calibrated_calorimeter_hit::get_time () const
    {
      return _time_;
    }
    ...
    double calibrated_calorimeter_hit::get_sigma_time () const
    {
      return _sigma_time_;
    }
    ...
    double calibrated_calorimeter_hit::get_energy () const
    {
      return _energy_;
    }
    ...
    double calibrated_calorimeter_hit::get_sigma_energy () const
    {
    ...
    calibrated_calorimeter_hit::~calibrated_calorimeter_hit ()
    {
      return;
    }
    ...
    void calibrated_calorimeter_hit::tree_dump (std::ostream & out_,
                                                ...
                                                bool inherit_) const
    {
      ...
      out_ << indent << datatools::i_tree_dumpable::tag
           << "Time  : " << _time_ / CLHEP::ns << " ns" << std::endl;

      out_ << indent << datatools::i_tree_dumpable::tag
           << "Sigma(time) : " << _sigma_time_ / CLHEP::ns << " ns" << std::endl;

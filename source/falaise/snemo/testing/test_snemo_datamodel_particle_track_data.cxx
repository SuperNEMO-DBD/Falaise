  ...
  try
    {
      ...
      std::clog << "Number of particles (before removing) = " << PTD.get_number_of_particles() << std::endl;
      ...
      std::clog << "Number of particles (after removing) = " << PTD.get_number_of_particles() << std::endl;

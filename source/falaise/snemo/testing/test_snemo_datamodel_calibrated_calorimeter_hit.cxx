...
int main (/* int argc_, char ** argv_ */)
{
  ...
  try {
    std::clog << "Test program for class 'snemo::datamodel::calibrated_calorimeter_hit'!" << std::endl;
...

    {
      ...
      for (hit_collection_type::const_iterator i
             = list_of_calo_hits.begin();
           i != list_of_calo_hits.end();
           i++) {

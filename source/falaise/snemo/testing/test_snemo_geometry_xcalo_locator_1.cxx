...
void test4(geomtools::manager& a_mgr) {
  ...
  clog << "Number of walls = " << CL.get_number_of_walls() << endl;

  clog << "Number of columns = " << CL.get_number_of_columns(0, 0) << endl;

  clog << "Number of rows = " << CL.get_number_of_rows(0, 0) << endl;

  clog << "Number of neighbours [0,0,0,0] = " << CL.get_number_of_neighbours(0, 0, 0, 0) << endl;

  clog << "Number of neighbours [0,0,0,12] = " << CL.get_number_of_neighbours(0, 0, 0, 12) << endl;

  clog << "Number of neighbours [0,0,0,5] = " << CL.get_number_of_neighbours(0, 0, 0, 5) << endl;

  clog << "Number of neighbours [0,0,1,15] = " << CL.get_number_of_neighbours(0, 0, 1, 15) << endl;

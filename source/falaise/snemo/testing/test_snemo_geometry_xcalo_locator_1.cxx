...
void test5 (geomtools::manager & a_mgr)
{
  ...
  for (uint32_t side = 0;  side < 2; side++)
    {
      {
        CL.get_neighbours_ids (side, 0, 0, 0, ids, snemo::geometry::utils::NEIGHBOUR_FIRST);
      ...
      {
        CL.get_neighbours_ids (side, 0, 0, 0, ids, snemo::geometry::utils::NEIGHBOUR_DIAG);
      ...
      {
        CL.get_neighbours_ids (side, 0, 1, 0, ids, snemo::geometry::utils::NEIGHBOUR_FIRST);
      ...
      {
        CL.get_neighbours_ids (side, 0, 1, 4, ids, snemo::geometry::utils::NEIGHBOUR_FIRST);
      ...
      {
        CL.get_neighbours_ids (side, 0, 0, 12, ids, snemo::geometry::utils::NEIGHBOUR_FIRST);
      ...
      {
        CL.get_neighbours_ids (side, 1, 1, 12, ids, snemo::geometry::utils::NEIGHBOUR_FIRST);
...

      {
        try
          {
            CL.get_neighbours_ids (side, 3, 0, 14, ids,snemo::geometry::utils::NEIGHBOUR_FIRST);
          }
        catch (exception & x)
          {

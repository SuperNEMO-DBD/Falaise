...
int main(int argc_, char ** argv_)
{
  ...
  try {
    std::clog << "Test program for the 'snemo::datamodel::tracker_clustering_data' class." << std::endl;
    ...
    // Event header bank :
    sdm::event_header & EH =
      ER.add<sdm::event_header>(sdm::data_info::EVENT_HEADER_LABEL);
    ...
    sdm::calibrated_data & CD =
      ER.add<sdm::calibrated_data>(sdm::data_info::CALIBRATED_DATA_LABEL);
...
// end of test_tracker_clustering_data.cxx

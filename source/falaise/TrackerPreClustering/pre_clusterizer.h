...
namespace TrackerPreClustering {
   ...
   *
   *  The TrackerPreClustering::pre_clusterizer object is configured through a TrackerPreClustering::setup_data
   *  object.
   *
   *  The input of the algorithm is implemented through the template TrackerPreClustering::input_data<> class which
   *  is basically a collection of Geiger hits.
   *
   *  The output of the algorithm is implemented through the template TrackerPreClustering::output_data<> class which
   *  stores collections of prompt and delayed clusters.
   *  By default the tracking chamber is considered as splitted in two parts.
   *
   */
  ...
  public:
    ...
    /// A 'Hit' class must be provided with the proper interface (see the TrackerPreClustering::gg_hit mock data model)
  ...
  public:
    ...
    bool operator()(const Hit * hit_ptr_i_,
                      const Hit * hit_ptr_j_) const
    {

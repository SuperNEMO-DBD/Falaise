...
void metadata_input::scan(const datatools::multi_properties& mp_) {
  ...
  if (ms.check_section("flsimulate", "flsimulate::section")) {
    ...
    ms.find_string("flsimulate", "flsimulate::section", "experimentalSetupUrn",
    ...
    if (this->doSimulation && ms.check_section("flsimulate.simulation", "flsimulate::section")) {
      ms.find_string("flsimulate.simulation", "flsimulate::section", "simulationSetupUrn",
                     this->simuSetupUrn);
    }

    // Digitization section:
    if (this->doDigitization &&
        ms.check_section("flsimulate.digitization", "flsimulate::section")) {
      ms.find_string("flsimulate.digitization", "flsimulate::section", "digitizationSetupUrn",
                     this->digiSetupUrn);
    }
  ...
  if (ms.check_section("flreconstruct", "flreconstruct::section")) {
    ...
    ms.find_string("flreconstruct", "flreconstruct::section", "experimentalSetupUrn",
                   this->experimentalSetupUrn);
    ms.find_size("flreconstruct", "flreconstruct::section", "numberOfEvents", this->numberOfEvents);

    // Reconstruction section:
    if (this->doReconstruction &&
        ms.check_section("flreconstruct.pipeline", "flreconstruct::section")) {
      ms.find_string("flreconstruct.pipeline", "flreconstruct::section", "configUrn",
                     this->recSetupUrn);
    }
...
void metadata_collector::set_input_data_file(const std::string& idf_) { _input_data_file_ = idf_; }
...
datatools::multi_properties metadata_collector::get_metadata() const {
  datatools::multi_properties md;
  return md;
}
...
const datatools::properties& metadata_scanner::get_section(
    const std::string& section_name_, const std::string& /*section_type_*/) const {
  return _mp_.get_section(section_name_);
}

bool metadata_scanner::find_boolean(const std::string& section_name_,
                                    const std::string& section_type_, const std::string& propKey_,
...
bool metadata_scanner::find_path(const std::string& section_name_, const std::string& section_type_,
...
bool metadata_scanner::find_size(const std::string& section_name_, const std::string& section_type_,
...
bool metadata_scanner::find_real(const std::string& section_name_, const std::string& section_type_,

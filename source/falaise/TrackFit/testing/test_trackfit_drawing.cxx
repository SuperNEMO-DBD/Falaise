...
int main (int argc_, char ** argv_)
{
  ...
  try {
    std::clog << "Test program for class 'drawing'!" << std::endl;
    ...
    if (draw) {
      ...
      g1.set_title ("Test TrackFit::drawing");
      {
        ...
        cmd_oss << " cm=10.; sz=45.;"
                ...
                << " set grid; ";
        cmd_oss << "plot ";
        cmd_oss << " '" << ftmp.get_filename () << "' index 0 using 1:2 title \"Cells (X-Y view)\" with lines; pause 3; ";
        cmd_oss << "splot ";
        cmd_oss << " '" << ftmp.get_filename () << "' index 0 using 1:2:3 title \"Cells (3D view)\" with lines; ";
        g1.cmd (cmd_oss.str ());

#@description BiPo3 module in its shielding
# +-------------------------------------------------------+
...
[name="nitrogen_gap.model" type="geomtools::simple_shaped_model"]
  ...
  internal_item.labels : string[6] = \
    ...
    internal_item.placement.calibration_source0 : string = "0 -399 498 (mm) / x 90 (deg)"
    ...
    internal_item.placement.calibration_source1 : string = "602 -399 498 (mm) / x 90 (deg)"
    ...
    internal_item.placement.calibration_source2 : string = "1204 -399 498 (mm) / x 90 (deg)"
    ...
    internal_item.placement.calibration_source3 : string = "-602 -399 498 (mm) / x 90 (deg)"
    ...
    internal_item.placement.calibration_source4 : string = "-1204 -399 498 (mm) / x 90 (deg)"
...
[name="iron_plate.model" type="geomtools::simple_shaped_model"]
  #@config Iron plate on top of the shielding
  shape_type : string = "box"
  x : real = 3640.0 mm
  y : real = 1000.0 mm
  z : real =   20.0 mm
...
[name="lead_shield.model" type="geomtools::simple_shaped_model"]
  ...
  visibility.hidden          : boolean = 0
  visibility.color           : string  = "cyan"
  internal_item.labels : string[2] = "nitrogen_gap" "iron_plate"
...
[name="shielded_bipo3_module.model" type="geomtools::simple_shaped_model"]
  #@config Last Air Volume around the detector
  shape_type : string = "box"
  x : real = 4700.0 mm
  y : real = 2100.0 mm
  z : real = 1800.0 mm

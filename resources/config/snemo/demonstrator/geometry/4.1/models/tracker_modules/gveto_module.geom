# -*- mode: conf-unix; -*-
# @falaise:config/snemo/demonstrator/geometry/4.1/models/tracker_module/gveto_module.geom
#
# DocDB 2079
#
...
# end of @falaise:config/snemo/demonstrator/geometry/4.1/models/tracker_module/gveto_module.geom

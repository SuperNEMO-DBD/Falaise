# -*- mode: conf-unix; -*-
# @falaise:config/snemo/demonstrator/geometry/4.1/models/tracker_module/xwall.geom
...
# end of @falaise:config/snemo/demonstrator/geometry/4.1/models/tracker_module/xwall.geom

# -*- mode: conf-unix; -*-
# @falaise:config/snemo/demonstrator/geometry/4.1/models/source_module/source_layer.geom
...
# end of @falaise:config/snemo/demonstrator/geometry/4.1/models/source_module/source_layer.geom

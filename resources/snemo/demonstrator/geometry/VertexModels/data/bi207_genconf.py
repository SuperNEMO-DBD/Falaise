...
Usage:
   ...
   $ cd Falaise.git/resources/snemo/demonstrator/geometry/VertexModels/data
   $ find . -name "bi207_calibration_sources.lis" 
   $ python3 bi207_genconf.py
   $ ls -l bi207_calibration_source_*_vg.conf

Then copy the generated files typically in the ``Falaise.git/resources/snemo/demonstrator/geometry/VertexModels/`` directory.

...
itep_strips_data="../flat/itep_strips.data"
...
if [ -f "source_itep_strips_snrs1.geom" ]; then
    rm -f source_itep_strips_snrs1.geom
fi

cat > source_itep_strips_snrs1.geom <<EOF
# -*- mode: conf-unix; -*-
...
for itep_strip_id in ${itep_strip_ids} ; do
    source_itep_strips_file="source_itep_strips_snrs1.geom"
    ...
    cat template/itep_strip_snrs1.geom.template | \
	sed \

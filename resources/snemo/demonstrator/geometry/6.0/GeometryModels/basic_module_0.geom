...
[name="module_basic.model" type="geomtools::simple_shaped_model"]
  ...
  shape_type : string = "box"
    ...
    y : real as length = 6100 mm
    z : real as length = 4100 mm
  material.ref     : string = "lab_air"
  visibility.color : string  = "grey"
  visibility.hidden           : boolean = false
  visibility.envelop_hidden   : boolean = false
  visibility.daughters.hidden : boolean = true
  # visibility.daughters.coil_mo_wall.shown : boolean = true
  # visibility.daughters.coil_tu_wall.shown : boolean = true
  # visibility.daughters.coil_fr_wall.shown : boolean = true
  # visibility.daughters.coil_it_wall.shown : boolean = true
  # visibility.daughters.coil_corner1.shown : boolean = true
  # visibility.daughters.coil_corner2.shown : boolean = true
  # visibility.daughters.coil_corner3.shown : boolean = true
  # visibility.daughters.coil_corner4.shown : boolean = true
  # visibility.daughters.source_submodule.shown : boolean = true 
  ...
  internal_item.labels : string[13] = \
	...
	internal_item.model.coil_tu_wall     : string = "coil_mo_tu_wall.model"
        ...
        internal_item.model.coil_corner1     : string = "coil_tilted_wall.model"
        internal_item.placement.coil_corner1 : string = "680 2830 0 (mm) / z 140 (degree)"

	internal_item.model.coil_corner2     : string = "coil_tilted_wall.model"
        internal_item.placement.coil_corner2 : string = "-680 -2830 0 (mm) / z 320 (degree)"

	internal_item.model.coil_corner3     : string = "coil_tilted_wall.model"
        internal_item.placement.coil_corner3 : string = "680 -2830 0 (mm) / z 40 (degree)"

	internal_item.model.coil_corner4     : string = "coil_tilted_wall.model"
        internal_item.placement.coil_corner4 : string = "-680 2830 0 (mm) / z 220 (degree)"

        mapping.daughter_id.coil_it_wall     : string = "[coil_wall:wall=0]"
        mapping.daughter_id.coil_fr_wall     : string = "[coil_wall:wall=1]"
        mapping.daughter_id.coil_mo_wall     : string = "[coil_wall:wall=2]"
        mapping.daughter_id.coil_tu_wall     : string = "[coil_wall:wall=3]"
        mapping.daughter_id.coil_corner1     : string = "[coil_wall:wall=6]"
        mapping.daughter_id.coil_corner2     : string = "[coil_wall:wall=8]"
        mapping.daughter_id.coil_corner3     : string = "[coil_wall:wall=9]"
        mapping.daughter_id.coil_corner4     : string = "[coil_wall:wall=7]"

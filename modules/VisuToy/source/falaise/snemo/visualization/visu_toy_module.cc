  ...
  namespace visualization {
                                     ...
                                     dpp::module_handle_dict_type & /* module_dict_ */)
    {
      ...
      if (setup_.has_key("min_event_count")) {
        ...
        DT_THROW_IF(n < 0, std::range_error,
      ...
      if (setup_.has_key("usleep_safe")) {
        ...
        DT_THROW_IF(n < 1, std::range_error,
                    "Module '" << get_name() << "' : Invalid time safe delay (" << n
                    << " < " << 1 << " us) !");
        _usleep_safe_ = n;
      }
    ...
    visu_toy_module::process(datatools::things & data_record_)
    {
      DT_THROW_IF (! is_initialized(), std::logic_error,
                    "Module '" << get_name() << "' is not initialized !");

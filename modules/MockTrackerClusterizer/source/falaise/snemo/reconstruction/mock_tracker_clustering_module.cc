...
namespace snemo {
  ...
  namespace reconstruction {
    ...
    const std::string & mock_tracker_clustering_module::get_cd_label() const
    {
      return _CD_label_;
    }

    void mock_tracker_clustering_module::set_tcd_label(const std::string & tcdl_)
    {
      DT_THROW_IF (is_initialized(), std::logic_error,
                   "Module '" << get_name() << "' is already initialized ! ");
      _TCD_label_ = tcdl_;
    ...
    const std::string & mock_tracker_clustering_module::get_tcd_label() const
    {
      return _TCD_label_;
    }

    const geomtools::manager & mock_tracker_clustering_module::get_geometry_manager() const
    {
      return *_geometry_manager_;
    }

    void mock_tracker_clustering_module::set_geometry_manager(const geomtools::manager & gmgr_)
    {
      DT_THROW_IF (is_initialized(), std::logic_error,
                   "Module '" << get_name() << "' is already initialized ! ");
    ...
    // Constructor :
    mock_tracker_clustering_module::mock_tracker_clustering_module(datatools::logger::priority logging_priority_)
    ...
    mock_tracker_clustering_module::process(datatools::things & data_record_)
    {
      DT_THROW_IF (! is_initialized(), std::logic_error,
                   "Module '" << get_name() << "' is not initialized !");
...
DOCD_CLASS_IMPLEMENT_LOAD_BEGIN(snemo::reconstruction::mock_tracker_clustering_module, ocd_)
{
...
DOCD_CLASS_SYSTEM_REGISTRATION(snemo::reconstruction::mock_tracker_clustering_module,
                               "snemo::reconstruction::mock_tracker_clustering_module")

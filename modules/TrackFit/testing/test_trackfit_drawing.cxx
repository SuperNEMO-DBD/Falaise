    ...
    if (draw) {
      ...
      g1.set_title ("Test TrackFit::drawing");
      {
        ...
        cmd_oss << " cm=10.; sz=45.;"
                ...
                << " set grid; ";
        cmd_oss << "plot ";
        cmd_oss << " '" << ftmp.get_filename () << "' index 0 using 1:2:4 title \"Hit cells (XY view)\" with lines linecolor variable lw 1; pause 3; ";
        cmd_oss << "splot ";
        cmd_oss << " '" << ftmp.get_filename () << "' index 0 using 1:2:3:4 title \"Hit cells (3D view)\" with lines linecolor variable lw 1; ";
        g1.cmd (cmd_oss.str ());

...
namespace TrackFit {
  ...
  public:
    ...
    static void compute_angles(const gg_hits_col & hits_,
                               helix_fit_params & traj_,
                               bool compute_step_ = false,
  ...
  private:
    ...
    double                    _fit_x_init_[helix_fit_params::HELIX_FIT_FIXED_START_TIME_NOPARS]; /// Parameters for the fitted helix

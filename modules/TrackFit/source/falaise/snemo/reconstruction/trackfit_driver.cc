...
DOCD_CLASS_IMPLEMENT_LOAD_BEGIN(snemo::reconstruction::trackfit_driver, ocd_)
{
  ...
  ocd_.set_class_documentation("The driver manager for the TrackFit fitting algorithms\n"
...

  {
    ...
    cpd.set_name_pattern("drift_time_calibration_label")
      ...
      .set_mandatory(false)
      .set_long_description("This parameter is only useful when one wants to perform  \n"
                            "the fit with on-the-fly calibration of the drift radius. \n"
                            )
      .set_default_value_string("snemo")
      .add_example("Use the SuperNEMO basic calibration::               \n"
                   "                                                    \n"
...

  {
    ...
    cpd.set_name_pattern("fitting_models")
      ...
      .set_mandatory(false)
      .set_long_description("Values are collected from the following list: \n"
                            " \"line\", \"helix\".                         \n")
      .add_example("Use all possible fits::                            \n"
                   "                                                   \n"
...

  {
    ...
    cpd.set_name_pattern("line.only_guess")
      ...
      .add_example("Use all the possible guesses::              \n"
                   "                                            \n"

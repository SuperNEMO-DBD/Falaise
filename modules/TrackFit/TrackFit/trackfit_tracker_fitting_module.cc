...
namespace snemo {
  ...
  namespace reconstruction {
    ...
    trackfit_tracker_fitting_module::process(datatools::things & event)
    {
      DT_THROW_IF(!is_initialized(), std::logic_error,
                  "Module '" << get_name() << "' is not initialized !");
    ...
    void trackfit_tracker_fitting_module::_process(const snemo::datamodel::tracker_clustering_data & clusters,

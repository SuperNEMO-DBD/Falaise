    ...
    default:
      ...
      _draw_manager_ = new default_draw_manager(_server_);
        ...
        if (_full_2d_display_) {
          ...
          main_->AddFrame(main_frame, new TGLayoutHints(kLHintsExpandX |
                                                        kLHintsExpandY));
          ...
          _tabs_ = new TGTab(right_part,
                             right_part->GetWidth(),
                             right_part->GetHeight());
          right_part->AddFrame(_tabs_, new TGLayoutHints(kLHintsExpandX |
                                                         kLHintsExpandY));
      ...
      void event_display::_update_tab_(const tab_id_index_type index_,
      ...
      void event_display::show_all(const button_signals_type signal_)
      {
        ...
        for (std::map<button_signals_type, bool>::iterator i = option_dict.begin();
             i != option_dict.end(); ++i)  i->second = false;

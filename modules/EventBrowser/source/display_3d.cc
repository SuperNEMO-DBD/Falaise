...
namespace snemo {
  ...
  namespace visualization {
    ...
    namespace view {
      ...
      // ctor:
      display_3d::display_3d (TGCompositeFrame * main_,
        ...
        _3d_viewer_ (0)
      {
        ...
        if (style_manager::get_instance ().use_opengl ())
          {
            _3d_viewer_ = new opengl_embedded_viewer ("3DPlot", main_,
                                                      width, height,
                                                      i_embedded_viewer::VIEW_3D);
          }
        else
#endif
          _3d_viewer_ = new pad_embedded_viewer ("3DPlot", main_,
                                                 width, height,
                                                 i_embedded_viewer::VIEW_3D);

        main_->AddFrame (_3d_viewer_->get_frame (), new TGLayoutHints(kLHintsExpandX |
                                                                      kLHintsExpandY));

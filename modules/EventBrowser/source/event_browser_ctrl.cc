...
namespace snemo {
  ...
  namespace visualization {
    ...
    namespace view {
      ...
      event_browser_ctrl::event_browser_ctrl(event_browser & browser_,
                                             size_t max_counts_)
      {
      ...
      void event_browser_ctrl::start()
      {
        ...
        DT_LOG_TRACE(options_manager::get_instance().get_logging_priority(), "Event browser thread is allocated...");
      ...
      bool event_browser_ctrl::is_stop_requested() const
      {

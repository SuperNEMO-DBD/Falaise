...
namespace snemo {
  ...
  namespace visualization {
    ...
    namespace view {
      ...
      // ctor:
      opengl_embedded_viewer::opengl_embedded_viewer (const std::string & name_,
      ...
      void opengl_embedded_viewer::reset ()
      {
        ...
        switch (_view_type_)
          ...
          case FRONT_VIEW:
            {
              this->SetOrthoCamera (TGLViewer::kCameraOrthoXOZ, 0.78, 0, 0,
                                    0.0, 0.0);
          ...
          case SIDE_VIEW:
            {
              this->SetOrthoCamera (TGLViewer::kCameraOrthoXOZ, 0.58, 0, 0,
                                    0.0, TMath::Pi ()/2.);
              this->SetCurrentCamera (TGLViewer::kCameraOrthoXOZ);
            }
            break;
      ...
      view_type opengl_embedded_viewer::get_view_type () const
      {
        return _view_type_;
      }
      ...
      TCanvas* opengl_embedded_viewer::get_canvas ()
      {
        return 0;
      }

      TGFrame* opengl_embedded_viewer::get_frame ()
      {
      ...
      void opengl_embedded_viewer::_set_cameras_ ()
      {
        ...
        double* center = 0;
        this->SetOrthoCamera (TGLViewer::kCameraOrthoXOZ, zoom, dolly, center,
                              0.0, TMath::Pi ()/2.);
      }

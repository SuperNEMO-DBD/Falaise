...
#include <EventBrowser/view/i_embedded_viewer.h>
...
class pad_embedded_viewer : public i_embedded_viewer, public TRootEmbeddedCanvas {
 public:
  ...
  virtual bool HandleContainerDoubleClick(Event_t* event_) {
    return _handle_container_double_click(event_);
  }
 ...
 private:
  ...
  void _convert_world_to_pad_coordinates_(const double xworld_, const double yworld_,
                                          const double zworld, double& xpad_, double& ypad_);

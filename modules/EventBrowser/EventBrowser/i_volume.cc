...
const std::string& volume_model::get_category() const { return _category; }

const std::string& volume_model::get_type() const { return _type; }

const geomtools::placement& volume_model::get_placement() const { return _placement; }

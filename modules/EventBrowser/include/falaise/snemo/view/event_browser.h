  ...
  namespace visualization {
    ...
    namespace view {
      ...
      public:
        ...
        /// Default constructor
        event_browser(const TGWindow * window_,
        ...
        void update_tab(const tab_id_index_type index_,
                        const bool reset_view_ = true);
        ...
        /// Change event signal
        void change_event(const button_signals_type signal_ = NEXT_EVENT,
      ...
      public:
        ...
        // ROOT Interface
        bool ProcessMessage (long msg_,
                             long parm1_,
                             long parm2_) { return process_message (msg_,parm1_,parm2_); }

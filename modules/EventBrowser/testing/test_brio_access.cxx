  ...
  try
    {
      ...
      // Validate file
      DT_THROW_IF (!my_brio_access.is_valid (brio_files), std::logic_error, "Files are not brio archives !");
      ...
      size_t i_event = 0;
      while (my_brio_access.retrieve_event (my_event_server.get_event (),
                                            i_event++))
        {

void param_pulse() {
  ...
  TF1* Parametrized_Pulse = new TF1("Parametrized_Pulse",
                                    " (x > [0] && x < [1])*gaus(2) + ((x>[1] && x<[5])*gaus(6)) "
                                    "-(x>[5] && x< 200)*([9]*(exp(-(x-[10])/[11])))",
                                    0, 200);
...
//   TF1 *Parametrized_Pulse = new TF1("Parametrized_Pulse"," (x > [0] && x < [1])*gaus(2) + ((x>[1]
//   && x<[5])*gaus(6)) -(x>[5] && x< 200)*([9]*(exp(-(x-[10])/[11])))",0,200);
//   Parametrized_Pulse->FixParameter(0,0);
//   Parametrized_Pulse->FixParameter(1,80.8924);
//   Parametrized_Pulse->FixParameter(2,-0.276085);
//   Parametrized_Pulse->FixParameter(3,81.4763);

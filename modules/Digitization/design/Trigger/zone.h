...
struct zone {
  ...
  static int start_row(int i_) {
    static constexpr int _start_row[tracker::NZONES] = {0, 9, 21, 33, 45, 57, 68, 80, 92, 104};
    return _start_row[i_];
  }

  static int stop_row(int i_) {
    static constexpr int _stop_row[tracker::NZONES] = {8, 20, 32, 44, 56, 67, 79, 91, 103, 112};
    return _stop_row[i_];
  }

  static int width(int i_) { return stop_row(i_) - start_row(i_) + 1; }

...
class geiger_ctw_data : public datatools::i_serializable {
 public:
  ...
  /// Return the clocktick min for the geiger crate trigger word with minimum clocktick (thanks to
  /// his index)
  uint32_t get_clocktick_min() const;

  /// Return the clocktick max for the geiger crate trigger word with maximum clocktick (thanks to
  /// his index)
  ...
  void get_list_of_geiger_ctw_per_clocktick(uint32_t clocktick_25ns_,
                                            geiger_ctw_collection_type& ctws_) const;

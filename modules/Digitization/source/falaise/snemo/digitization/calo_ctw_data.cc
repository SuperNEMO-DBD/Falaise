...
DATATOOLS_SERIALIZATION_SERIAL_TAG_IMPLEMENTATION(calo_ctw_data,
                                                  "snemo::digitalization::calo_ctw_data")

calo_ctw_data::calo_ctw_data() { return; }
...
void calo_ctw_data::get_list_of_calo_ctw_per_clocktick(uint32_t clocktick_25ns_,
...
void calo_ctw_data::tree_dump(std::ostream& out_, const std::string& title_,

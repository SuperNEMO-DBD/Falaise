...
#ifndef FALAISE_DIGITIZATION_PLUGIN_SNEMO_DIGITIZATION_SD_TO_GEIGER_TP_ALGO_H
#define FALAISE_DIGITIZATION_PLUGIN_SNEMO_DIGITIZATION_SD_TO_GEIGER_TP_ALGO_H
...
namespace snemo {
  ...
  namespace digitization {		
    ...
    class sd_to_geiger_tp_algo : boost::noncopyable
    {
    public :

      /// Default constructor
      sd_to_geiger_tp_algo();

      /// Destructor
      virtual ~sd_to_geiger_tp_algo();
...
#endif // FALAISE_DIGITIZATION_PLUGIN_SNEMO_DIGITIZATION_SD_TO_GEIGER_TP_ALGO_H

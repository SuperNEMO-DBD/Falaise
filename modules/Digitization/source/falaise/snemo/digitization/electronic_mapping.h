...
class electronic_mapping {
 ...
 public:
  ...
  void convert_GID_to_EID(const bool tracker_trigger_mode_, const geomtools::geom_id& geom_id_,
 ...
 protected:
  ...
  void _convert_GID_to_EID(const bool tracker_trigger_mode_, const geomtools::geom_id& geom_id_,
  ...
  void _convert_EID_to_GID(const bool tracker_trigger_mode_,
                           const geomtools::geom_id& electronic_id_, geomtools::geom_id& geom_id_);

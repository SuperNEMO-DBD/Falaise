...
double geiger_signal::get_anode_avalanche_time() const { return _anode_avalanche_time_; }
...
double geiger_signal::get_plasma_top_time_() const { return _plasma_top_time_; }
...
double geiger_signal::get_plasma_bottom_time_() const { return _plasma_bottom_time_; }
...
bool geiger_signal::is_valid() const { return true; }
...
void geiger_signal::tree_dump(std::ostream& out_, const std::string& title_,
                              const std::string& indent_, bool inherit_) const {
  base_hit::tree_dump(out_, title_, indent_, inherit_ = true);

  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Avalanche anode time =  : " << _anode_avalanche_time_ / CLHEP::microsecond << " us "
       << std::endl;

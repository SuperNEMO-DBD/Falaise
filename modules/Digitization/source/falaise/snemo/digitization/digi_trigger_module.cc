/// \file falaise/snemo/digitization/digi_trigger_module.cc
// Author(s): Guillaume OLIVIERO <goliviero@lpccaen.in2p3.fr>

// Ourselves:
#include <snemo/digitization/digi_trigger_module.h>
...
// This plugin (digi_trigger_module) :
...
namespace snemo { 
  ...
  namespace digitization {
    ...
    DPP_MODULE_REGISTRATION_IMPLEMENT(digi_trigger_module,
                                      "snemo::digitization::digi_trigger_module")
    
    digi_trigger_module::digi_trigger_module(datatools::logger::priority logging_priority_)
    ...
    digi_trigger_module::~digi_trigger_module()
    {
      if (is_initialized()) digi_trigger_module::reset();
      return;
    }    

    void digi_trigger_module::_set_defaults()
    {
      _SD_label_ = snemo::datamodel::data_info::default_simulated_data_label();
      return;
    }
    
    void digi_trigger_module::initialize(const datatools::properties  & setup_,
					 ...
					 
    {
      ...
      // Algo :
      _algo_.reset(new snemo::digitization::trigger_algorithm_test_time);
      _algo_->initialize();
      // Tag the module as initialized :
      _set_initialized(true);
    }    

    void digi_trigger_module::reset()
    {
      DT_THROW_IF(! is_initialized(),
                  std::logic_error,
    ...
    dpp::base_module::process_status digi_trigger_module::process(datatools::things & data_record_)
    {
    ...
    dpp::base_module::process_status digi_trigger_module::_process(const mctools::simulated_data & /*SD_*/)
    {
      DT_LOG_TRACE(get_logging_priority(), "Entering...");

      /*
      // XXX signature has to be change because trigger algorihtm does not return a boolean
...
DOCD_CLASS_IMPLEMENT_LOAD_BEGIN(snemo::digitization::digi_trigger_module, ocd_)
{
  ocd_.set_class_name("snemo::digitization::digi_trigger_module");
...
DOCD_CLASS_SYSTEM_REGISTRATION(snemo::digitization::digi_trigger_module,
			       "snemo::digitization::digi_trigger_module")

// end of falaise/snemo/digitization/digi_trigger_module.cc

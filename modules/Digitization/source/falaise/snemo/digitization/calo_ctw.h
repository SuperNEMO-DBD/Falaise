...
class calo_ctw : public geomtools::base_hit {
 public:
  ...
  enum tw_mask_type {
    TW_HTM_PC = datatools::bit_mask::bit00 |
                datatools::bit_mask::bit01,  //!< High threshold multiplicity per crate (HTM-PC)
    TW_ZONING =
        datatools::bit_mask::bit02 | datatools::bit_mask::bit03 | datatools::bit_mask::bit04 |
        datatools::bit_mask::bit05 | datatools::bit_mask::bit06 | datatools::bit_mask::bit07 |
        datatools::bit_mask::bit08 | datatools::bit_mask::bit09 | datatools::bit_mask::bit10 |
        datatools::bit_mask::bit11,  //!< Zoning word, depends on the type of the crate (10 bits)
    ...
    TW_CONTROL = datatools::bit_mask::bit14 | datatools::bit_mask::bit15 |
                 datatools::bit_mask::bit16 | datatools::bit_mask::bit17  //!< Control bits (4 bits)
  };
  ...
  void get_main_zoning_word(
      std::bitset<calo::ctw::MAIN_ZONING_BITSET_SIZE>& main_zoning_word_) const;

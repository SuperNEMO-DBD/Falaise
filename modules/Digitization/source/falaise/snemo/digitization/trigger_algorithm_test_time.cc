...
namespace snemo {
  ...
  namespace digitization {
    ...
    void trigger_algorithm_test_time::clear_records()
    {
      DT_THROW_IF(!is_initialized(), std::logic_error, "Trigger algorithm is not initialized, it can't be reset ! ");
      _tracker_records_.clear();
      _calo_records_.clear();
    ...
    const std::vector<calo_trigger_algorithm_test_time::calo_summary_record> trigger_algorithm_test_time::get_calo_records_vector() const  
    {
      return _calo_records_;
    }	

    const std::vector<coincidence_trigger_algorithm_test_time::coincidence_calo_record> trigger_algorithm_test_time::get_coincidence_calo_records_vector() const
    {

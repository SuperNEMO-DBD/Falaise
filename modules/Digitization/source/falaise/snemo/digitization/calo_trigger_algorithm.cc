...
void calo_trigger_algorithm::set_electronic_mapping(
...
calo_trigger_algorithm::get_total_multiplicity_threshold_coinc() const {
...
bool calo_trigger_algorithm::is_initialized() const { return _initialized_; }
...
bool calo_trigger_algorithm::get_calo_decision() const { return _calo_finale_decision_; }

const calo_trigger_algorithm::calo_summary_record
calo_trigger_algorithm::get_calo_level_1_finale_decision_structure() {
...
void calo_trigger_algorithm::_build_calo_record_summary_structure(
    calo_summary_record& my_calo_summary_record_) {
  ...
  for (boost::circular_buffer<calo_record>::iterator it = _gate_circular_buffer_->begin();
...
void calo_trigger_algorithm::_compute_calo_finale_decision(
    calo_summary_record& my_calo_summary_record_) {
...
void calo_trigger_algorithm::process(
...
void calo_trigger_algorithm::_process(
    const calo_ctw_data& calo_ctw_data_,
    std::vector<calo_trigger_algorithm::calo_summary_record>& calo_records_) {
  _calo_record_per_clocktick_.reset();
  _calo_level_1_finale_decision_.reset();

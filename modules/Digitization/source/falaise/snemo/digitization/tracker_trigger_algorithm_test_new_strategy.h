  ...
  namespace digitization {		
    ...
    typedef memory<8,3> mem5_type; // Zone Vertical for horizontal memory
      ...
      bool _initialized_; //!< Initialization
			...
			mem1_type _sliding_zone_vertical_memory_;
			mem2_type _sliding_zone_horizontal_memory_;
			mem3_type _zone_vertical_memory_;
			mem4_type _zone_horizontal_memory_;
			mem5_type _zone_vertical_for_horizontal_memory_;

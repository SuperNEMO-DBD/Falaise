...
/// \brief Algorithm processing. Take a geiger_tp_data object (collection of geiger_tp) in input
/// used to fill a geiger_ctw_data (collection of geiger crate trigger word) in output.
class geiger_tp_to_ctw_algo {
 ...
 protected:
  ...
  void _process_for_a_ctw_for_a_clocktick(

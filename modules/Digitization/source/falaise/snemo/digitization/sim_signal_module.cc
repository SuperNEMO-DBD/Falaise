...
DPP_MODULE_REGISTRATION_IMPLEMENT(sim_signal_module, "snemo::digitization::sim_signal_module")
...
void sim_signal_module::driver_entry::initialize() {
  if (handle.get() == nullptr) {
    DT_THROW_IF(type_id.empty(), std::logic_error,
                "Missing type identifier for driver '" << name << "'!");
    ...
    DT_THROW_IF(!sys_factory_register.has(type_id), std::logic_error,
                "Unknown signal generator driver class with id = '" << type_id << "' for driver '"
                                                                    << name << "'!");
...
::snemo::digitization::base_signal_generator_driver&
sim_signal_module::driver_entry::grab_driver() {
  initialize();
  return *handle.get();
}
...
const std::string& sim_signal_module::get_sd_label() const { return _SD_label_; }
...
const std::string& sim_signal_module::get_ssd_label() const { return _SSD_label_; }
...
const std::string& sim_signal_module::get_geo_label() const { return _Geo_label_; }

bool sim_signal_module::has_geometry_manager() const { return _geometry_manager_ != nullptr; }
...
bool sim_signal_module::is_abort_at_missing_input() const { return _abort_at_missing_input_; }
...
bool sim_signal_module::is_abort_at_former_output() const { return _abort_at_former_output_; }
...
bool sim_signal_module::is_preserve_former_output() const { return _preserve_former_output_; }
...
void sim_signal_module::add_driver(const std::string& name_, const std::string& type_id_,
...
// Processing :
dpp::base_module::process_status sim_signal_module::process(datatools::things& data_record_) {
  DT_THROW_IF(!is_initialized(), std::logic_error,
              "Module '" << get_name() << "' is not initialized !");

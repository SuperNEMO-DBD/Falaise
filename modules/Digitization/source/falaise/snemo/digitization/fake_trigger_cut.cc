...
const std::string& fake_trigger_cut::get_SD_label() const { return _SD_label_; }
...
DOCD_CLASS_SYSTEM_REGISTRATION(snemo::digitization::fake_trigger_cut,
                               "snemo::digitization::fake_trigger_cut")

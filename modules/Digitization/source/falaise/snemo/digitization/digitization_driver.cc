...
bool digitization_driver::has_geometry_manager() const { return _geometry_manager_ != 0; }
...
bool digitization_driver::is_initialized() const { return _initialized_; }

void digitization_driver::reset() { return; }

void digitization_driver::process_digitization_algorithms(
    const mctools::signal::signal_data& /*SSD_*/) {
  return;
}

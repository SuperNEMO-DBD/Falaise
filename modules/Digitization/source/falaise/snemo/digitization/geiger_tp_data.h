...
namespace snemo {
  ...
  namespace digitization {		
    ...
    /// \brief Collection of geigerrimeter trigger primitive (geiger_tp)
	...
	void get_list_of_tp_per_clocktick(int32_t clocktick_25ns_, geiger_tp_collection_type & my_list_of_tps_per_clocktick_) const;
			
	/// Get a list of geiger trigger primitive which are in the same clocktick and in the same crate
	void get_list_of_tp_per_clocktick_per_crate(int32_t clocktick_25ns_, unsigned int crate_number_, geiger_tp_collection_type & my_list_of_tps_per_clocktick_per_crate_ ) const;

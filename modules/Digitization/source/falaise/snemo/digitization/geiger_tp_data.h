...
class geiger_tp_data : public datatools::i_serializable  // or DATATOOLS_SERIALIZABLE_CLASS
{
 public:
  ...
  void get_list_of_gg_tp_per_clocktick(
  ...
  void get_list_of_gg_tp_per_clocktick_per_crate(
  ...
  void get_list_of_gg_tp_per_eid(const geomtools::geom_id& electronic_id_,
...
BOOST_CLASS_EXPORT_KEY2(snemo::digitization::geiger_tp_data, "snemo::digitization::geiger_tp_data")

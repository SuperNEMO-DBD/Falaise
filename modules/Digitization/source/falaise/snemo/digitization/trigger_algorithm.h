...
class trigger_algorithm {
 public:
  ...
  get_coincidence_records_vector() const;
 ...
 private:
  ...
  // Data :
  std::vector<calo_trigger_algorithm::calo_summary_record>
      _calo_records_;  //!< Collection of calo summary record
  std::vector<tracker_trigger_algorithm::tracker_record>
      _tracker_records_;  //!< Collection of tracker record
  std::vector<coincidence_trigger_algorithm::coincidence_event_record>
      _coincidence_records_;  //!< Collection of coincidence record
  std::vector<coincidence_trigger_algorithm::previous_event_record>
      _previous_prompt_event_records_;  //!< Collection (if needed) of previous event output

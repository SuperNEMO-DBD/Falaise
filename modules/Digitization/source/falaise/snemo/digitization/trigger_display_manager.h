...
class trigger_display_manager {
 ...
 private:
  ...
  bool _decision_trigger_;  //!< Configuration to display the moment when the trigger decision is
                            //!< true

  // Data :
  char _char_matrix_[NUMBER_OF_VERTICAL_CHAR][NUMBER_OF_HORIZONTAL_CHAR];  //!< Matrix of characters
                                                                           //!< representing
                                                                           //!< calorimeter zones
                                                                           //!< and geiger matrix
};

...
DATATOOLS_SERIALIZATION_SERIAL_TAG_IMPLEMENTATION(geiger_tp_data,
                                                  "snemo::digitalization::geiger_tp_data")

geiger_tp_data::geiger_tp_data() { return; }
...
void geiger_tp_data::get_list_of_gg_tp_per_clocktick(
    uint32_t clocktick_800ns_, geiger_tp_collection_type& my_list_of_gg_tps_per_clocktick_) const {
...
void geiger_tp_data::get_list_of_gg_tp_per_clocktick_per_crate(
    uint32_t clocktick_800ns_, unsigned int crate_number_,
    geiger_tp_collection_type& my_list_of_gg_tps_per_clocktick_per_crate_) const {
  for (unsigned int i = 0; i < _geiger_tps_.size(); i++) {
    if (_geiger_tps_[i].get().get_clocktick_800ns() == clocktick_800ns_ &&
        _geiger_tps_[i].get().get_geom_id().get(mapping::CRATE_INDEX) == crate_number_) {
...
void geiger_tp_data::get_list_of_gg_tp_per_eid(
    const geomtools::geom_id& electronic_id_,
    geiger_tp_collection_type& my_list_of_gg_tps_per_eid_) const {
...
void geiger_tp_data::tree_dump(std::ostream& out_, const std::string& title_,

// snemo/digitization/tracker_trigger_mem_maker_new_strategy.cc
...
namespace snemo {
  ...
  namespace digitization {
    ...
    tracker_trigger_mem_maker_new_strategy::tracker_trigger_mem_maker_new_strategy()
    {
      _initialized_      = false;
    ...
    void tracker_trigger_mem_maker_new_strategy::initialize()
    {
    ...
    bool tracker_trigger_mem_maker_new_strategy::is_initialized() const
    {
      return _initialized_;
    }

    void tracker_trigger_mem_maker_new_strategy::reset()
    {
      _initialized_   = false;
      _mem_type_      = MEM_UNDEFINED;
      return;
    ...
    void tracker_trigger_mem_maker_new_strategy::configure(const mem_type & memory_type_)
    {
      _mem_type_      = memory_type_;
      return;
    }

    void tracker_trigger_mem_maker_new_strategy::_build()
    {
      switch (_mem_type_)
	{
	case MEM_UNDEFINED :
    ...
    void tracker_trigger_mem_maker_new_strategy::_build_mem1()
    {
    ...
    void tracker_trigger_mem_maker_new_strategy::_build_mem2()
    {
    ...
    void tracker_trigger_mem_maker_new_strategy::_build_mem3()
    {
    ...
    void tracker_trigger_mem_maker_new_strategy::_build_mem4()
    {
    ...
    void tracker_trigger_mem_maker_new_strategy::_build_mem5()
    {
    ...
    void tracker_trigger_mem_maker_new_strategy::store_to_file(const std::string & output_file_,

...
namespace snemo {
  ...
  namespace digitization {
    ...
    void coincidence_trigger_algorithm::set_previous_event_buffer_depth(unsigned int previous_event_circular_buffer_depth_)
    {
    ...
    const std::vector<coincidence_trigger_algorithm::coincidence_calo_record> coincidence_trigger_algorithm::get_coincidence_calo_records_vector() const
    {
      ...
      for (; it != calo_records_.end(); it++)
	{
	  ...
	  if (a_ctrec.calo_finale_decision == true)
		  ...
		  if (ctrec_clocktick_1600ns == _coincidence_calo_records_[i].clocktick_1600ns)
		      ...
		      if (i != _coincidence_calo_records_.size() - 1)
			{
			  for (unsigned int j = i+1; j < _coincidence_calo_records_.size(); j++)
				...
				{
				  uint32_t clocktick_1600_before_modification = _coincidence_calo_records_[j].clocktick_1600ns;
		      ...
		      for (unsigned int j = clocktick_max_1600 + 1; j <= clocktick_to_create; j++)
			{
			  ...
			  if (no_same_clocktick == true)
			    {
			      coincidence_trigger_algorithm::coincidence_calo_record grow_back_coincidence_calo_record = _coincidence_calo_records_[index_max];
	      ...
	      if (coinc_calo_record_find == false)
		{
		  ...
		  for (uint32_t iclocktick = new_coincidence_calo_record.clocktick_1600ns + 1; iclocktick < new_coincidence_calo_record.clocktick_1600ns + _coincidence_calorimeter_gate_size_; iclocktick ++)
		    {
		      coincidence_trigger_algorithm::coincidence_calo_record new_on_gate_coincidence_calo_record;
      ...
      // std::vector<coincidence_trigger_algorithm::coincidence_calo_record>::const_iterator it_coinc = _coincidence_calo_records_.begin();
      // for (; it_coinc != _coincidence_calo_records_.end(); it_coinc++)
      // 	{
      // 	  const coincidence_trigger_algorithm::coincidence_calo_record a_coinc_calo_record = *it_coinc;
    ...
    void coincidence_trigger_algorithm::_update_coinc_calo_record(const calo_trigger_algorithm::calo_summary_record & a_calo_summary_record_25ns_, coincidence_trigger_algorithm::coincidence_calo_record & a_coinc_calo_record_1600ns_)
    {
    ...
    void coincidence_trigger_algorithm::_creating_pair_per_clocktick(const std::vector<coincidence_trigger_algorithm::coincidence_calo_record> & coinc_calo_records_,
								     const std::vector<tracker_trigger_algorithm::tracker_record> & tracker_records_)
    {
      std::pair<coincidence_trigger_algorithm::coincidence_calo_record,tracker_trigger_algorithm::tracker_record> pair_for_a_clocktick;
	...
	{
	  std::pair<coincidence_trigger_algorithm::coincidence_calo_record, tracker_trigger_algorithm::tracker_record> last_pair = _pair_records_.back();
    ...
    void coincidence_trigger_algorithm::_process_calo_tracker_coincidence(const std::pair<coincidence_trigger_algorithm::coincidence_calo_record, tracker_trigger_algorithm::tracker_record> a_pair_for_a_clocktick_,
    ...
    void coincidence_trigger_algorithm::_build_previous_event_record(coincidence_trigger_algorithm::coincidence_event_record & a_coincidence_record_)    
    {
    ...
    void coincidence_trigger_algorithm::_process_delayed_coincidence(const std::pair<coincidence_trigger_algorithm::coincidence_calo_record, tracker_trigger_algorithm::tracker_record> a_pair_for_a_clocktick_,
						 ...
						 std::vector<coincidence_trigger_algorithm::coincidence_event_record> & coincidence_records_)
    {
      ...
      std::vector<std::pair<coincidence_trigger_algorithm::coincidence_calo_record,tracker_trigger_algorithm::tracker_record> >::iterator it_pair = _pair_records_.begin();
      for (; it_pair != _pair_records_.end(); it_pair++)
	{
	  ...
	  if (a_coincidence_record.decision)
		...
		{
		  boost::circular_buffer<coincidence_trigger_algorithm::previous_event_record>::iterator per_it = _previous_event_records_->begin();

...
namespace snemo {
  ...
  namespace digitization {
    ...
    void trigger_algorithm::process(const calo_trigger_algorithm::calo_summary_record & calo_sumary_record_)
    {
    ...
    void trigger_algorithm::_process(const calo_trigger_algorithm::calo_summary_record & calo_sumary_record_)
    {
      return;
    }

...
namespace snemo {
  ...
  namespace digitization {
    ...
    {
      return static_cast<int>(FALAISE_DIGITIZATION_VERSION_MAJOR);
    }

    int version::get_minor()
    {
      return static_cast<int>(FALAISE_DIGITIZATION_VERSION_MINOR);
    }

    int version::get_patch()
    {
      return static_cast<int>(FALAISE_DIGITIZATION_VERSION_PATCH);
    }

    int version::get_revision()
    {
      return static_cast<int>(FALAISE_DIGITIZATION_VERSION_REVISION);
    }
    ...
    std::string version::get_version()
    {
      ...
      if (version.empty()) {
        ...
        stream << FALAISE_DIGITIZATION_VERSION_MAJOR << "."

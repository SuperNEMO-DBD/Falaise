...
int version::get_major() { return static_cast<int>(FALAISE_DIGITIZATION_VERSION_MAJOR); }

int version::get_minor() { return static_cast<int>(FALAISE_DIGITIZATION_VERSION_MINOR); }

int version::get_patch() { return static_cast<int>(FALAISE_DIGITIZATION_VERSION_PATCH); }

int version::get_revision() { return static_cast<int>(FALAISE_DIGITIZATION_VERSION_REVISION); }
...
std::string version::get_version() {
  ...
  if (version.empty()) {
    ...
    stream << FALAISE_DIGITIZATION_VERSION_MAJOR << "." << FALAISE_DIGITIZATION_VERSION_MINOR << "."
...
bool version::is_at_least(int major, int minor, int patch) {
  if (FALAISE_DIGITIZATION_VERSION_MAJOR < major) return false;
  if (FALAISE_DIGITIZATION_VERSION_MAJOR > major) return true;
  if (FALAISE_DIGITIZATION_VERSION_MINOR < minor) return false;
  if (FALAISE_DIGITIZATION_VERSION_MINOR > minor) return true;
  if (FALAISE_DIGITIZATION_VERSION_PATCH < patch) return false;
  return true;
}

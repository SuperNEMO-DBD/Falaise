...
struct tracker_zone {
  enum bit_index { DATA_NEAR_SOURCE_BIT_RIGHT = 0, DATA_NEAR_SOURCE_BIT_LEFT = 1 };
  ...
  bool cells[snemo::digitization::trigger_info::NLAYERS]
            [snemo::digitization::trigger_info::ZONE_WIDTH];
  unsigned int side;
  ...
  std::bitset<snemo::digitization::trigger_info::ZONE_ADDR_LMR_PATTERN_SIZE>
      addr_left_mid_right_pattern;
  std::bitset<snemo::digitization::trigger_info::ZONE_ADDR_LMR_WIO_PATTERN_SIZE>
      addr_left_mid_right_with_in_out_pattern;

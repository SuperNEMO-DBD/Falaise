...
namespace snemo {
  ...
  namespace digitization {		
    ...
    class tracker_trigger_algorithm_test_near_source
    {				
    public : 
			...
			static const int32_t GEIGER_LEVEL_ONE_ZONING_BITSET_SIZE = 10;
			
			/// Level two zoning size of a bitset for a zone
			static const int32_t GEIGER_LEVEL_TWO_ZONING_BITSET_SIZE = 4;
			
			/// Final bitset size for geiger zoning
			static const int32_t GEIGER_ZONING_FINAL_BITSET_SIZE = 4;
			...
			enum tracker_trigger_info_level_one_bitset_index {
			  ...
			  RIGHT_NEAR_SOURCE_L1_INDEX = 8,
				LEFT_NEAR_SOURCE_L1_INDEX  = 9
			};			
			
			enum tracker_trigger_info_level_two_bitset_index {
				PATTERN_BIT_0_L2_INDEX = 0,
				PATTERN_BIT_1_L2_INDEX = 1,
			  RIGHT_NEAR_SOURCE_L2_INDEX = 2,
				LEFT_NEAR_SOURCE_L2_INDEX  = 3
			};

      /// Default constructor
			tracker_trigger_algorithm_test_near_source();

      /// Destructor
      virtual ~tracker_trigger_algorithm_test_near_source();
      ...
      void reset(); 
			...
			const tracker_trigger_algorithm_test_near_source::tracker_record get_tracker_level_1_finale_decision_structure() const;
    ...
    private :
      ...
      bool _geiger_matrix_[mapping::NUMBER_OF_SIDES][mapping::NUMBER_OF_LAYERS][mapping::NUMBER_OF_GEIGER_ROWS]; //!< Geiger cells matrix
			...
			std::bitset<GEIGER_LEVEL_ONE_ZONING_BITSET_SIZE-2> _level_one_prime_tracker_trigger_info_[mapping::NUMBER_OF_SIDES][mapping::NUMBER_OF_TRACKER_TRIGGER_INTERZONES]; //!< Table of 2x10 containing 8 bits bitset representing the level one tracker trigger for the interzones	 
			...
			std::bitset<GEIGER_LEVEL_TWO_ZONING_BITSET_SIZE-2> _level_two_prime_tracker_trigger_info_[mapping::NUMBER_OF_SIDES][mapping::NUMBER_OF_TRACKER_TRIGGER_INTERZONES]; //!< Table of 2x9 containing 2 bits bitset representing if there is a track / pretrack or nothing in one interzone

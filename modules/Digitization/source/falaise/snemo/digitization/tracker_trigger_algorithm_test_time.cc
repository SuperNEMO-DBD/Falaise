...
void tracker_trigger_algorithm_test_time::set_electronic_mapping(
...
bool tracker_trigger_algorithm_test_time::is_initialized() const { return _initialized_; }
...
uint32_t tracker_trigger_algorithm_test_time::get_board_id(
...
void tracker_trigger_algorithm_test_time::build_hit_cells_gids_from_ctw(
...
void tracker_trigger_algorithm_test_time::fill_matrix(
...
const trigger_structures::geiger_matrix
tracker_trigger_algorithm_test_time::get_geiger_matrix_for_a_clocktick() const {
...
void tracker_trigger_algorithm_test_time::build_sliding_zone(unsigned int side_,
                                                             unsigned int szone_id_) {
  ...
  for (unsigned int ilayer = 0; ilayer < trigger_info::NLAYERS; ilayer++) {
    for (unsigned int irow = start_row; irow <= stop_row; irow++) {
      _sliding_zones_[side_][szone_id_].cells[ilayer][irow - start_row] =
          _a_geiger_matrix_for_a_clocktick_.matrix[side_][ilayer][irow];
    }
  }
...
void tracker_trigger_algorithm_test_time::build_sliding_zones(
    tracker_trigger_mem_maker::mem1_type& mem1_, tracker_trigger_mem_maker::mem2_type& mem2_) {
  for (unsigned int iside = 0; iside < trigger_info::NSIDES; iside++) {
    for (unsigned int iszone = 0; iszone < trigger_info::NSLZONES; iszone++) {
...
void tracker_trigger_algorithm_test_time::build_in_out_pattern(
    tracker_zone& zone_, tracker_trigger_mem_maker::mem3_type& mem3_) {
...
void tracker_trigger_algorithm_test_time::build_left_mid_right_pattern(
    ...
    for (unsigned int izone = 0; izone < trigger_info::NZONES; izone++) {
      a_tracker_record_
          .finale_data_per_zone[iside][izone]
                               [trigger_structures::tracker_record::FINALE_DATA_BIT_INNER] =
          _zones_[iside][izone].data_in_out_pattern[0];
      a_tracker_record_
          .finale_data_per_zone[iside][izone]
                               [trigger_structures::tracker_record::FINALE_DATA_BIT_OUTER] =
          _zones_[iside][izone].data_in_out_pattern[1];
      a_tracker_record_
          .finale_data_per_zone[iside][izone]
                               [trigger_structures::tracker_record::FINALE_DATA_BIT_RIGHT] =
          _zones_[iside][izone].data_left_mid_right_pattern[0];
      a_tracker_record_
          .finale_data_per_zone[iside][izone]
                               [trigger_structures::tracker_record::FINALE_DATA_BIT_MIDDLE] =
          _zones_[iside][izone].data_left_mid_right_pattern[1];
      a_tracker_record_
          .finale_data_per_zone[iside][izone]
                               [trigger_structures::tracker_record::FINALE_DATA_BIT_LEFT] =
          _zones_[iside][izone].data_left_mid_right_pattern[2];
      a_tracker_record_
          .finale_data_per_zone[iside][izone]
                               [trigger_structures::tracker_record::FINALE_DATA_BIT_NSZ_RIGHT] =
          _zones_[iside][izone].data_near_source[0];
      a_tracker_record_
          .finale_data_per_zone[iside][izone]
                               [trigger_structures::tracker_record::FINALE_DATA_BIT_NSZ_LEFT] =
  ...
  for (unsigned int iside = 0; iside < trigger_info::NSIDES; iside++) {
    for (unsigned int izone = 0; izone < trigger_info::NZONES; izone++) {
      ...
      hpattern_for_a_zone[0] =
          a_tracker_record_.finale_data_per_zone
              [iside][izone][trigger_structures::tracker_record::FINALE_DATA_BIT_RIGHT];  // RIGHT
      hpattern_for_a_zone[1] =
          a_tracker_record_.finale_data_per_zone
              [iside][izone][trigger_structures::tracker_record::FINALE_DATA_BIT_MIDDLE];  // MIDDLE
      hpattern_for_a_zone[2] =
          a_tracker_record_.finale_data_per_zone
              [iside][izone][trigger_structures::tracker_record::FINALE_DATA_BIT_LEFT];  // LEFT
      near_source_for_a_zone[0] =
          a_tracker_record_.finale_data_per_zone
              [iside][izone]
              [trigger_structures::tracker_record::FINALE_DATA_BIT_NSZ_RIGHT];  // NSZRIGHT
      near_source_for_a_zone[1] =
          a_tracker_record_.finale_data_per_zone
              [iside][izone]
              [trigger_structures::tracker_record::FINALE_DATA_BIT_NSZ_LEFT];  // NSZLEFT
...
void tracker_trigger_algorithm_test_time::_process_for_a_clocktick(
  ...
  _a_geiger_matrix_for_a_clocktick_.clocktick_1600ns =
      geiger_ctw_list_per_clocktick_[0].get().get_clocktick_800ns();
...
void tracker_trigger_algorithm_test_time::_process(
    const std::vector<datatools::handle<geiger_ctw> > geiger_ctw_list_per_clocktick_,
    trigger_structures::tracker_record& a_tracker_record_) {
  _process_for_a_clocktick(geiger_ctw_list_per_clocktick_, a_tracker_record_);
  return;
}

void tracker_trigger_algorithm_test_time::process(
    const std::vector<datatools::handle<geiger_ctw> > geiger_ctw_list_per_clocktick_,
    trigger_structures::tracker_record& a_tracker_record_) {
  DT_THROW_IF(!is_initialized(), std::logic_error,
              "Tracker trigger algorithm is not initialized, it can't process ! ");
  if (geiger_ctw_list_per_clocktick_.size() != 0) {
    _process(geiger_ctw_list_per_clocktick_, a_tracker_record_);
  } else {
    _a_geiger_matrix_for_a_clocktick_.reset();
    reset_zones_informations();
  }

...
namespace snemo {
  ...
  namespace digitization {
		...
		protected :
			...
			void _process_calo_tracker_coincidence(const std::pair<coincidence_trigger_algorithm::coincidence_calo_record, tracker_trigger_algorithm::tracker_record> a_pair_for_a_clocktick_,
			...
			void _build_previous_event_record(coincidence_trigger_algorithm::coincidence_event_record & a_coincidence_record_);

			/// Alpha delayed Pattern Event (APE) process for delayed
			void _process_delayed_coincidence(const std::pair<coincidence_trigger_algorithm::coincidence_calo_record, tracker_trigger_algorithm::tracker_record> a_pair_for_a_clocktick_,
		...
		private :
			...
			typedef boost::circular_buffer<coincidence_trigger_algorithm::previous_event_record> buffer_previous_event_record_type;
      ...
      const electronic_mapping * _electronic_mapping_; //!< Convert geometric ID into electronic ID
			...
			std::vector<coincidence_trigger_algorithm::coincidence_calo_record> _coincidence_calo_records_; //!< Vector of coincidence calo tracker record and delayed coincidence record
			std::vector<std::pair<coincidence_trigger_algorithm::coincidence_calo_record, tracker_trigger_algorithm::tracker_record> > _pair_records_; //!< Pair of a coincidence calo record and a tracker record (at the same clocktick 1600 ns)
			...
			std::vector<coincidence_trigger_algorithm::L2_coincidence_decision> _L2_coincidence_decison_records_; //!< Vector of L2 decision for an event (it is possible to trig several times for the same "SD" event	
		};

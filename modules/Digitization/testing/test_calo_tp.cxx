...
int main(int argc_, char** argv_) {
  ...
  try {
    ...
    // Hit_id and geom_id used are mocked id (just choose for the test) because "real id" come from
    // simulated datas.
    my_calo_tp.set_hit_id(42);
    my_calo_tp.grab_geom_id().set_type(25);
    my_calo_tp.grab_geom_id().set_address(3, 0,
                                          7);  // address type(RACK_INDEX, CRATE_INDEX, BOARD_INDEX)
    ...
    my_calo_tp.set_htm(3);  // Argument is the multiplicity. Here 3 caloFEBs passed the high

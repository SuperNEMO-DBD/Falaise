...
int main(int argc_, char** argv_) {
  ...
  try {
    ...
    // production_file =
    // "${FALAISE_DIGITIZATION_TESTING_DIR}/config/trigger/tracker/A6_D1_default_memory.data";
    ...
    // my_memory_maker.store(production_file, "Default A5D1 memory for level 0 to level 1 tracker
    // trigger. Maximum gap = 1 for the projection on rows.");

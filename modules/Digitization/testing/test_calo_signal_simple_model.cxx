...
void test_calo_signal_simple_model_1(bool draw_) {
  ...
  //  "${FALAISE_DIGITIZATION_TESTING_DIR}/data/calo_signal_shape_1300kev_mean_8000_signals.data";
  std::string input_datafile =
      "${FALAISE_DIGITIZATION_TESTING_DIR}/data/calo_signal_reference_shape_reduced_1000kev.data";
...
void test_calo_signal_simple_model_2(bool draw_) {
  ...
  double dx = 0.01;
  for (double x = cas1.get_analog_signal_shape().x_min();
       x <= cas1.get_analog_signal_shape().x_max() + 0.001 * dx; x += dx) {

...
int main(int argc_, char** argv_) {
  ...
  try {
    ...
    my_e_mapping.convert_GID_to_EID(snemo::digitization::mapping::THREE_WIRES_TRACKER_MODE, GID1,
                                    EID1);
    std::cout << "GID1 : " << GID1;
    std::cout << " ---> EID1 : " << EID1 << std::endl;

    my_e_mapping.convert_GID_to_EID(snemo::digitization::mapping::THREE_WIRES_TRACKER_MODE, GID2,
                                    EID2);
    std::cout << "GID2 : " << GID2;
    std::cout << " ---> EID2 : " << EID2 << std::endl;

    my_e_mapping.convert_GID_to_EID(snemo::digitization::mapping::THREE_WIRES_TRACKER_MODE, GID3,
                                    EID3);
    std::cout << "GID3 : " << GID3;
    std::cout << " ---> EID3 : " << EID3 << std::endl;

    my_e_mapping.convert_GID_to_EID(snemo::digitization::mapping::THREE_WIRES_TRACKER_MODE, GID4,
                                    EID4);
    std::cout << "GID4 : " << GID4;
    std::cout << " ---> EID4 : " << EID4 << std::endl;

    my_e_mapping.convert_GID_to_EID(snemo::digitization::mapping::THREE_WIRES_TRACKER_MODE, GID5,
                                    EID5);
    std::cout << "GID5 : " << GID5;

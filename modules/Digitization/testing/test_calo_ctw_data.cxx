...
int main(int argc_, char** argv_) {
  ...
  try {
    ...
    std::clog << "Size of my list of calo CTW for a clocktick = 20  : "
              << my_list_of_ctw_per_clocktick.size() << " calo CTW(s) in the list " << std::endl;

    for (unsigned int i = 0; i < my_list_of_ctw_per_clocktick.size(); i++) {
      my_list_of_ctw_per_clocktick[i].get().tree_dump(

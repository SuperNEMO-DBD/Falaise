...
int main(int argc_, char **argv_) {
  ...
  try {
    ...
    int coincidence_calorimeter_gate_size =
        8;  // Number of CT 1600 coincidence gate for calorimeter
    ...
    snemo::digitization::calo_ctw_data my_calo_ctw_data;
    {
      ...
      geomtools::geom_id my_ctw_gid(snemo::digitization::mapping::CALORIMETER_CONTROL_BOARD_TYPE,
                                    snemo::digitization::mapping::CALO_RACK_ID, 0,
                                    10);  // GID : [type]:[RACK],[CRATE],[BOARD]
      my_calo_ctw.set_header(42, my_ctw_gid,
    ...
    }
    {
      ...
      geomtools::geom_id my_ctw_gid(snemo::digitization::mapping::CALORIMETER_CONTROL_BOARD_TYPE,
                                    snemo::digitization::mapping::CALO_RACK_ID, 0,
                                    10);  // GID : [type]:[RACK],[CRATE],[BOARD]
      my_calo_ctw.set_header(43, my_ctw_gid,
    ...
    //   snemo::digitization::calo_ctw & my_calo_ctw = my_calo_ctw_data.add();
    //   geomtools::geom_id my_ctw_gid(snemo::digitization::mapping::CALORIMETER_CONTROL_BOARD_TYPE,
    //   snemo::digitization::mapping::CALO_RACK_ID, 1, 10); // GID : [type]:[RACK],[CRATE],[BOARD]
    ...
    //   snemo::digitization::calo_ctw & my_calo_ctw = my_calo_ctw_data.add();
    //   geomtools::geom_id my_ctw_gid(snemo::digitization::mapping::CALORIMETER_CONTROL_BOARD_TYPE,
    //   snemo::digitization::mapping::CALO_RACK_ID, 0, 10); // GID : [type]:[RACK],[CRATE],[BOARD]
    //   my_calo_ctw.set_header(58,
    // 			     my_ctw_gid,
...

    {
      snemo::digitization::calo_ctw &my_calo_ctw = my_calo_ctw_data.add();
      geomtools::geom_id my_ctw_gid(snemo::digitization::mapping::CALORIMETER_CONTROL_BOARD_TYPE,
                                    snemo::digitization::mapping::CALO_RACK_ID, 1,
                                    10);  // GID : [type]:[RACK],[CRATE],[BOARD]
      my_calo_ctw.set_header(47, my_ctw_gid,
    ...
    //   geomtools::geom_id my_ctw_gid(snemo::digitization::mapping::TRACKER_CONTROL_BOARD_TYPE,
    //   snemo::digitization::mapping::GEIGER_RACK_ID, 1, 10); my_geiger_ctw.set_header(86,
    // 			       my_ctw_gid
    // 			       );
    ...
    std::vector<snemo::digitization::coincidence_trigger_algorithm::coincidence_calo_record>
        coincidence_collection_calo_records = my_trigger_algo.get_coincidence_calo_records_vector();

    if (debug)
      std::clog << "Calo collection record size @ 25ns   = " << calo_collection_records.size()
                << std::endl;
    if (debug)
      std::clog << "Calo collection record size @ 1600ns = "
                << coincidence_collection_calo_records.size() << std::endl;

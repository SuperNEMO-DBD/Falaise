...
int main(int argc_, char **argv_) {
  ...
  try {
    std::clog << "Test program for class 'snemo::digitization::geiger_tp_to_ctw_algo' !"
              << std::endl;
    ...
    // Creation of few geiger tps
    {
      ...
      std::bitset<55> my_gg_tp_bitset(
          std::string("0000000000000000000010101010000000000000000000010101010"));

...
int main(int argc_, char **argv_) {
  ...
  try {
    std::clog << "Test program for class 'snemo::digitization::calo_trigger_algorithm' !"
              << std::endl;
    int32_t seed = 314159;
    ...
    // std::string memory_mult_layer   =
    // "${FALAISE_DIGITIZATION_TESTING_DIR}/config/trigger/tracker/A5_D1_default_min_mult_memory.data";
      ...
      if (ER.has(SD_bank_label) && ER.is_a<mctools::simulated_data>(SD_bank_label)) {
        ...
        if (SD.has_step_hits("calo") || SD.has_step_hits("xcalo") || SD.has_step_hits("gveto")) {
          ...
          if (signal_data.has_calo_signals()) {
            ...
            snemo::digitization::calo_trigger_algorithm::calo_summary_record
                calo_level_one_finale_decision;
            calo_level_one_finale_decision =
                my_calo_algo.get_calo_level_1_finale_decision_structure();

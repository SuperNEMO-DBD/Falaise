...
int main(int argc_, char** argv_) {
  ...
  if (is_help) {
    std::cerr << std::endl
              << "Usage :" << std::endl
              << std::endl
              << "$ BuildProducts/bin/falaisedigitizationplugin-test_trigger_algorithm [OPTIONS] "
                 "[ARGUMENTS]"
              << std::endl
              << std::endl
              ...
              << "Example : " << std::endl
              << std::endl
              << "$ BuildProducts/bin/falaisedigitizationplugin-test_trigger_algorithm --input "
  ...
  try {
    ...
    if (is_input_file) {
      ...
      pipeline_simulated_data_filename =
          ...
          "Se82_2nubb_500000-source_strips_bulk_SD.brio";
      // pipeline_simulated_data_filename =
      // "${DATA_NEMO_PERSO_DIR}/trigger/simulated_data_brio/Bi214_Po214_500000-source_strips_bulk_SD.brio";
      // pipeline_simulated_data_filename=
      // "/home/goliviero/software/my_falaise/outputs/Bi214_Po214_10000-source_strips_surface_SD.brio";
    }
    ...
    std::string root_filename =
        "${FALAISE_DIGITIZATION_TESTING_DIR}/output_default/trigger_decision.root";
    ...
    trigger_decision_tree->Branch("trigger_decision_root", &trigger_decision_root,
                                  "trigger_decision/O");

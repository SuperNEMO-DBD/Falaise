//fldigi_tracker_trigger_mem_maker_new_strategy.cxx
...
int main( int  argc_ , char ** argv_  )
{
  ...
  try {
    std::clog << "TEST : testing program tracker mem maker new strategy " << std::endl;
    ...
    snemo::digitization::tracker_trigger_mem_maker_new_strategy my_memory_maker;
    
    my_memory_maker.configure(snemo::digitization::tracker_trigger_mem_maker_new_strategy::MEM1);
    my_memory_maker.initialize();
    my_memory_maker.store_to_file(mem1_file, "Default mem1.conf : Sliding Zone Vertical memory");
    
    my_memory_maker.configure(snemo::digitization::tracker_trigger_mem_maker_new_strategy::MEM2);
    my_memory_maker.initialize();
    my_memory_maker.store_to_file(mem2_file, "Default mem2.conf : Sliding Zone Horizontal memory");
    
    my_memory_maker.configure(snemo::digitization::tracker_trigger_mem_maker_new_strategy::MEM3);
    my_memory_maker.initialize();
    my_memory_maker.store_to_file(mem3_file, "Default mem3.conf : Zone Vertical memory");
    
    my_memory_maker.configure(snemo::digitization::tracker_trigger_mem_maker_new_strategy::MEM4);
    my_memory_maker.initialize();
    my_memory_maker.store_to_file(mem4_file, "Default mem4.conf : Zone Horizontal memory");

    my_memory_maker.configure(snemo::digitization::tracker_trigger_mem_maker_new_strategy::MEM5);
    my_memory_maker.initialize();

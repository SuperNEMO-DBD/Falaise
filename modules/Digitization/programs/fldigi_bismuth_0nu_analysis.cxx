      ...
      if (ER.has(SD_bank_label) && ER.is_a<mctools::simulated_data>(SD_bank_label)) {
        ...
        if (SD.has_step_hits("calo") || SD.has_step_hits("xcalo")) {
          ...
          if (SD.has_step_hits("calo"))
            number_of_main_calo_hits = SD.get_number_of_step_hits("calo");
          std::size_t number_of_xwall_calo_hits = 0;
          if (SD.has_step_hits("xcalo"))
            number_of_xwall_calo_hits = SD.get_number_of_step_hits("xcalo");
          ...
          for (size_t ihit = 0; ihit < number_of_main_calo_hits; ihit++) {
            ...
            std::map<geomtools::geom_id, double>::iterator it_map =
                gid_energy_calo_map.find(main_calo_gid);
          ...
          for (size_t ihit = 0; ihit < number_of_xwall_calo_hits; ihit++) {
            ...
            std::map<geomtools::geom_id, double>::iterator it_map =
                gid_energy_calo_map.find(xwall_calo_gid);
            double previous_energy = 0;
            if (it_map != gid_energy_calo_map.end()) {
              previous_energy = it_map->second;
              double new_energy = previous_energy += energy_deposit;
        ...
        if (is_verbose) {
          ...
          std::clog << "Main calorimeters fired = " << number_of_main_wall_calorimeters
                    ...
                    << " Total fired = "
                    << number_of_main_wall_calorimeters + number_of_xwall_calorimeters << std::endl;
        ...
        if (gid_energy_calo_map.size() == 2 &&
            ((vertex_position.getX() >= -0.09) &&
             (vertex_position.getX() <= 0.09)))  // only 2 pm hits
        {
          ...
          // if ((gid_calo_1.get(3) == gid_calo_2.get(3) + 1 || gid_calo_1.get(3) ==
          // gid_calo_2.get(3) - 1)
          //     && (gid_calo_1.get(4) == gid_calo_2.get(4) + 1 || gid_calo_1.get(4) ==
          //     gid_calo_2.get(4) - 1))
          //   {
          ...
          if (total_energy >= 2.8 && total_energy <= 3.2 && number_of_geiger_cells >= 18) {
            ...
            std::clog << "Energy C1 : " << energy_calo_1 << " Energy C2 : " << energy_calo_2

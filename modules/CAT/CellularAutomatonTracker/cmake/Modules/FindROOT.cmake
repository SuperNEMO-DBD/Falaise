...
# Modified by Ben Morgan <Ben.Morgan@warwick.ac.uk>
# - Use standard system search paths, prefer the order
# - ROOT_ROOT
# - ROOTSYS from environment
# - PATH

MESSAGE(STATUS "Searching for CERN ROOT")

SET(ROOT_CONFIG_SEARCHPATH ${ROOT_ROOT}/bin $ENV{ROOTSYS}/bin)
...
FIND_PROGRAM(ROOT_CONFIG_EXECUTABLE NAMES root-config 
    PATHS ${ROOT_CONFIG_SEARCHPATH} ENV PATH
    NO_DEFAULT_PATH)

    
IF (${ROOT_CONFIG_EXECUTABLE} MATCHES "ROOT_CONFIG_EXECUTABLE-NOTFOUND")
    MESSAGE( FATAL_ERROR "root-config not found under
...
IF (ROOT_CONFIG_EXECUTABLE)
  ...
  MESSAGE(STATUS "Found ROOT version: ${ROOTVERSION}")   
...
#   MESSAGE("BLA: ${bla}")
   ...
   ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
      ...
      ARGS -f ${OUTFILE} -c -p -DHAVE_CONFIG_H ${INCLUDE_DIRS} ${INFILES} ${LINKDEF_FILE} DEPENDS ${INFILES})

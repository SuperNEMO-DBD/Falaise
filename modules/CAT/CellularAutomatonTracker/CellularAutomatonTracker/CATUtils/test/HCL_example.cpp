...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  double height_0 = aHistogram.binHeight(mybhep::HCL::Axis::UNDERFLOW_BIN,
                                         mybhep::HCL::Axis::UNDERFLOW_BIN);
  double height_2 = aHistogram.binHeight(mybhep::HCL::Axis::OVERFLOW_BIN,
                                         mybhep::HCL::Axis::UNDERFLOW_BIN);
  double height_6 = aHistogram.binHeight(mybhep::HCL::Axis::UNDERFLOW_BIN,
                                         mybhep::HCL::Axis::OVERFLOW_BIN);
  double height_8 = aHistogram.binHeight(mybhep::HCL::Axis::OVERFLOW_BIN,
                                         mybhep::HCL::Axis::OVERFLOW_BIN);
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {
   mybhep::HCL::Profile1D* histogram = 
     new mybhep::HCL::Profile1D("Profile",100,-5,5,-2,2);
   for(int count=0;count<entries;count++) {
...

 {
  ...
  {
    mybhep::HCL::Base1D* slice = histogram->sliceX(mybhep::HCL::Axis::UNDERFLOW_BIN,
                                            mybhep::HCL::Axis::UNDERFLOW_BIN);
    if(!slice) return -1;
  ...
  {
    mybhep::HCL::Base1D* slice = histogram->sliceX(mybhep::HCL::Axis::OVERFLOW_BIN,
                                            mybhep::HCL::Axis::OVERFLOW_BIN);
    if(!slice) return -1;
  ...
  {
    mybhep::HCL::Base1D* slice = histogram->sliceY(mybhep::HCL::Axis::UNDERFLOW_BIN,
                                            mybhep::HCL::Axis::UNDERFLOW_BIN);
    if(!slice) return -1;
  ...
  {
    mybhep::HCL::Base1D* slice = histogram->sliceY(mybhep::HCL::Axis::OVERFLOW_BIN,
                                            mybhep::HCL::Axis::OVERFLOW_BIN);
    if(!slice) return -1;

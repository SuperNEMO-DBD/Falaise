  ...
  while (!is.eof() && ievt < 100) 
    {
      ...
      // names of properties
      cout << "names of event properties" 
	   << print_vector(evt->properties()) << endl;
      cout << "values of event properties" 
	   << print_vector(evt->properties_values()) << endl;
      ...
      cout << "names of particles properties" 
	   << print_vector(pp->properties()) << endl;
      cout << "values of particle properties" 
	   << print_vector(pp->properties_values()) << endl;
	...
	cout << " event type = " 
	     << evt2.fetch_property("event_type") << endl;

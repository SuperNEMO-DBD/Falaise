...
namespace mybhep{
  ...
  */
  ...
  public:
    ...
    bool find_property(std::string name) const
    {
    ...
    std::string fetch_property(std::string name) const
    {
     ...
     //! change a property
    void change_property(std::string name,std::string prop)
    {
      prop_[name]=prop;
    }
    ...
    const std::map<std::string,std::string>& properties_map() const
    {
    ...
    //! return properties name
    const std::vector<std::string> properties_values()
    {
      return prop_.items();
    }

...
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::HistogramData::HistogramData(
 const mybhep::HCL::HistogramData& aFrom
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
void mybhep::HCL::HistogramData::copy(
 const mybhep::HCL::HistogramData& aFrom
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
mybhep::HCL::Histogram::Histogram(
 int aDimension 
,const std::vector<int>& aNumbers
,const std::vector<double>& aMins
,const std::vector<double>& aMaxs
,bool aProfile
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Histogram::Histogram(
 const mybhep::HCL::Histogram& aHistogram
)
...
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Histogram::Histogram(
 const mybhep::HCL::HistogramData& aData
)
:HistogramData(aData)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Histogram& mybhep::HCL::Histogram::operator=(
 const Histogram& aHistogram
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram::configure(
 int aDimension 
,const std::vector<int>& aNumbers
,const std::vector<double>& aMins
,const std::vector<double>& aMaxs
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram::isValid(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
const mybhep::HCL::HistogramData& mybhep::HCL::Histogram::getData(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
const mybhep::HCL::Axis& mybhep::HCL::Histogram::getAxis(
 int aIndex
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram::isCompatible(
 const Histogram& aHistogram
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram::isProfile(
) const 
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Histogram::getDimension(
) const 
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
const std::string& mybhep::HCL::Histogram::getTitle(
) const 
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Histogram::getBins(
) const 
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Histogram::getEntries(
) const 
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Histogram::getAllEntries(
) const 
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getSw(
) const 
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getSw2(
) const 
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
void mybhep::HCL::Histogram::copy(
 const mybhep::HCL::Histogram& aFrom
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram::subtract(
 const Histogram& aHistogram
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram::multiply(
 const Histogram& aHistogram
)
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram::divide(
 const Histogram& aHistogram
)
//////////////////////////////////////////////////////////////////////////////
// We build a new histo with one entry in each bean of weight : 
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram::fillBin(
 const std::vector<double>& aXs
,double aWeight
)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Histogram::getBinEntries(
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getBinHeight(
 const std::vector<int>& aIs
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getBinError(
 const std::vector<int>& aIs
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
std::vector<double> mybhep::HCL::Histogram::getBinMean(
 const std::vector<int>& aIs
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
std::vector<double> mybhep::HCL::Histogram::getBinStdDev(
 const std::vector<int>& aIs
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getBinRMS(
 const std::vector<int>& aIs
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getIthAxisSxw(
 int aAxis
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getIthAxisSx2w(
 int aAxis
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getIthAxisMean(
 int aAxis
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getIthAxisRMS(
 int aAxis
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Histogram::getIthAxisBinEntries(
 int aAxis
,int aIndex
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Histogram::getIthAxisBinHeight(
 int aAxis
,int aIndex
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Histogram::getOffset(
 const std::vector<double>& aXs
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
void mybhep::HCL::Histogram::getIndices(
 int aOffset
,std::vector<int>& aIs
) const
//////////////////////////////////////////////////////////////////////////////
...
const std::string& aClass::title() const {\
  return fTitle;\
}\
...
bool aClass::scale(double aFactor) {\
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base1D::binEntries(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base1D::binHeight(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base1D::binError(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base1D::binCenter(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base1D::binMean(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base1D*)this)->fInts[0] = aI;
  ...
  if(!IS_EQUAL(mean,meanNotOpt))
    printf("debug : mybhep::HCL::Base1D::binMean : anomaly\n");}
#endif
  return mean;
}
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base1D::binStdDev(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base1D*)this)->fInts[0] = aI;
  ...
  if(!IS_EQUAL(rms,rmsNotOpt))
    printf("debug : mybhep::HCL::Base1D::binStdDev : anomaly\n");}
#endif
  return rms;
}
//////////////////////////////////////////////////////////////////////////////
const mybhep::HCL::Axis& mybhep::HCL::Base1D::axis(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base1D::coordToIndex(
 double aCoord
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram1D::fill(
 double aX
,double aWeight
)
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Profile1D::fill(
 double aX
,double aV
,double aWeight
)
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Profile1D::binRms(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::meanX(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::meanY(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base2D::binEntries(
 int aI
,int aJ
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binHeight(
 int aI
,int aJ
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binError(
 int aI
,int aJ
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binCenterX(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binCenterY(
 int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binMeanX(
 int aI
,int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base2D*)this)->fInts[0] = aI;
  ...
  double meanNotOpt = getBinMean(fInts)[0];
  if(!IS_EQUAL(mean,meanNotOpt))
    printf("debug : mybhep::HCL::Base2D::binMeanX : anomaly\n");}
#endif
  return mean;
}
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binMeanY(
 int aI
,int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base2D*)this)->fInts[0] = aI;
  ...
  if(!IS_EQUAL(mean,meanNotOpt))
    printf("debug : mybhep::HCL::Base2D::binMeanY : anomaly\n");}
#endif
  return mean;
}
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binStdDevX(
 int aI
,int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base2D*)this)->fInts[0] = aI;
  ...
  double rmsNotOpt = getBinStdDev(fInts)[0];
  if(!IS_EQUAL(rms,rmsNotOpt))
    printf("debug : mybhep::HCL::Base2D::binStdDevX : anomaly\n");}
#endif
  return rms;
}
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binStdDevY(
 int aI
,int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base2D*)this)->fInts[0] = aI;
  ...
  if(!IS_EQUAL(rms,rmsNotOpt))
    printf("debug : mybhep::HCL::Base2D::binStdDevY : anomaly\n");}
#endif
  return rms;
}
//////////////////////////////////////////////////////////////////////////////
const mybhep::HCL::Axis& mybhep::HCL::Base2D::xAxis(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
const mybhep::HCL::Axis& mybhep::HCL::Base2D::yAxis(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base2D::coordToIndexX(
 double aCoord
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base2D::coordToIndexY(
 double aCoord
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Base1D* mybhep::HCL::Base2D::sliceX(
 int aJbeg
,int aJend
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  mybhep::HCL::Base1D* sliceX = new Base1D("SliceX",
                                   xAxis().bins(),
                                   xAxis().lowerEdge(),
                                   xAxis().upperEdge());
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Base2D::fillSliceX(
 mybhep::HCL::Base1D& aHisto
,int aJbeg
,int aJend
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Base1D* mybhep::HCL::Base2D::sliceY(
 int aIbeg
,int aIend
) const
//////////////////////////////////////////////////////////////////////////////
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  mybhep::HCL::Base1D* sliceY = new Base1D("SliceY",
                                   yAxis().bins(),
                                   yAxis().lowerEdge(),
                                   yAxis().upperEdge());
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Base2D::fillSliceY(
 mybhep::HCL::Base1D& aHisto
,int aIbeg
,int aIend
) const
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base2D::binEntriesX(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binHeightX(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  if(!IS_EQUAL(sw,swNotOpt))
    printf("debug : binHeightX : anomaly at %d : %g\n",aI,sw);
#endif
  return sw;
}
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base2D::binEntriesY(
 int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base2D::binHeightY(
 int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  if(!IS_EQUAL(sw,swNotOpt))
    printf("debug : binHeightY : anomaly at %d : %g\n",aJ,sw);
#endif
  return sw;
}
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Base1D* mybhep::HCL::Base2D::projectionX(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Base1D* mybhep::HCL::Base2D::projectionY(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram2D::fill(
 double aX
,double aY
,double aWeight
)
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  else if(jbin==(fAxes[1].fNumberOfBins+1)) inRange = false;
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Profile2D::fill(
 double aX
,double aY
,double aV
,double aWeight
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Profile2D::binRms(
 int aI
,int aJ
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::meanX(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::meanY(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::meanZ(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base3D::binEntries(
 int aI
,int aJ
,int aK
) const
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binHeight(
 int aI
,int aJ
,int aK
) const
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binError(
 int aI
,int aJ
,int aK
) const
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binCenterX(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binCenterY(
 int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binCenterZ(
 int aK
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binMeanX(
 int aI
,int aJ
,int aK
) const
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binMeanY(
 int aI
,int aJ
,int aK
) const
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binMeanZ(
 int aI
,int aJ
,int aK
) const
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binStdDevX(
 int aI
,int aJ
,int aK
) const
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base3D*)this)->fInts[0] = aI;
  ...
  double rmsNotOpt = getBinStdDev(fInts)[0];
  if(!IS_EQUAL(rms,rmsNotOpt))
    printf("debug : mybhep::HCL::Base3D::binStdDevX : anomaly\n");}
#endif
  return rms;
}
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binStdDevY(
 int aI
,int aJ
,int aK
) const
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base3D*)this)->fInts[0] = aI;
  ...
  double rmsNotOpt = getBinStdDev(fInts)[1];
  if(!IS_EQUAL(rms,rmsNotOpt))
    printf("debug : mybhep::HCL::Base3D::binStdDevY : anomaly\n");}
#endif
  return rms;
}
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binStdDevZ(
 int aI
,int aJ
,int aK
) const
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
 ...
 {((Base3D*)this)->fInts[0] = aI;
  ...
  if(!IS_EQUAL(rms,rmsNotOpt))
    printf("debug : mybhep::HCL::Base3D::binStdDevZ : anomaly\n");}
#endif
  return rms;
}
//////////////////////////////////////////////////////////////////////////////
const mybhep::HCL::Axis& mybhep::HCL::Base3D::xAxis(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
const mybhep::HCL::Axis& mybhep::HCL::Base3D::yAxis(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
const mybhep::HCL::Axis& mybhep::HCL::Base3D::zAxis(
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base3D::coordToIndexX(
 double aCoord
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base3D::coordToIndexY(
 double aCoord
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base3D::coordToIndexZ(
 double aCoord
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Base2D* mybhep::HCL::Base3D::sliceXY(
 int aKbeg
,int aKend
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  mybhep::HCL::Base2D* sliceXY = new Base2D("SliceXY",
                                              xAxis().bins(),
                                              xAxis().lowerEdge(),
                                              xAxis().upperEdge(),
                                              yAxis().bins(),
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Base3D::fillSliceXY(
 mybhep::HCL::Base2D& aHisto
,int aKbeg
,int aKend
) const
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Base2D* mybhep::HCL::Base3D::sliceYZ(
 int aIbeg
,int aIend
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  mybhep::HCL::Base2D* sliceYZ = new Base2D("SliceYZ",
                                              yAxis().bins(),
                                              yAxis().lowerEdge(),
                                              yAxis().upperEdge(),
                                              zAxis().bins(),
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Base3D::fillSliceYZ(
 mybhep::HCL::Base2D& aHisto
,int aIbeg
,int aIend
) const
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
mybhep::HCL::Base2D* mybhep::HCL::Base3D::sliceXZ(
 int aJbeg
,int aJend
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  mybhep::HCL::Base2D* sliceXZ = new Base2D("SliceXZ",
                                              xAxis().bins(),
                                              xAxis().lowerEdge(),
                                              xAxis().upperEdge(),
                                              zAxis().bins(),
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Base3D::fillSliceXZ(
 mybhep::HCL::Base2D& aHisto
,int aJbeg
,int aJend
) const
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base3D::binEntriesX(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binHeightX(
 int aI
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base3D::binEntriesY(
 int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binHeightY(
 int aJ
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
int mybhep::HCL::Base3D::binEntriesZ(
 int aK
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
double mybhep::HCL::Base3D::binHeightZ(
 int aK
) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
...
//////////////////////////////////////////////////////////////////////////////
bool mybhep::HCL::Histogram3D::fill(
 double aX
,double aY
,double aZ
,double aWeight
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  else if(kbin==(fAxes[2].fNumberOfBins+1)) inRange = false;

...
*/
  ...
  public:
    ...
    reader_txt& get_reader_txt()
    {
      return *rt_;
    }

    reader_gz& get_reader_gz()
    {
      return *rz_;
    }

    //#ifdef HDF5
    reader_hdf5& get_reader_hdf5()
    {
      return *rh_;
    }
    //#endif
    writer_hdf5& get_writer_hdf5()
    {
      return *wh_;
    }
    //#endif

    writer_txt& get_writer_txt()
    {
      return *wt_;
    }

    writer_gz& get_writer_gz()
    {
      return *wz_;
    }

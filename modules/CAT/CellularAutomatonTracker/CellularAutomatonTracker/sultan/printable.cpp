...
printable::printable() { level_ = VERBOSE; }

printable::~printable() {}

//! print interface
void printable::info(std::ostream& os) const { os << " no information available" << endl; }
...
//! return print_level
const prlevel& printable::print_level() const { return level_; }

//! set print_level
//    void set_print_level(prlevel& level) {level_ = level;}
void printable::set_print_level(prlevel level) { level_ = level; }

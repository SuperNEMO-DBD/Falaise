...
#ifndef __SULTAN__plane_h
#define __SULTAN__plane_h 1
...
class plane : public tracking_object {
 ...
 public:
  ...
  //! constructor
  plane(const experimental_point &center, const experimental_vector &sizes,
        const experimental_vector &norm, mybhep::prlevel level = mybhep::NORMAL,
  ...
  //! set
  void set(const experimental_point &center, const experimental_vector &sizes,
  ...
  bool intersect(const experimental_point &start, const experimental_vector &direction,

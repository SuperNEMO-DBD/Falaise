...
class tracked_data : public tracking_object {
 ...
 public:
  ...
  tracked_data(const std::vector<cell>& cells, const std::vector<calorimeter_hit>& calos,
               ...
               const std::vector<sequence>& nemo_sequences, mybhep::prlevel level = mybhep::NORMAL,
  ...
  //! set true sequences
  void set_true_sequences(const std::vector<sequence>& sequences) { true_sequences_ = sequences; }

  //! set nemo sequences
  void set_nemo_sequences(const std::vector<sequence>& sequences) { nemo_sequences_ = sequences; }
  ...
  //! get true sequences
  std::vector<sequence>& get_true_sequences() { return true_sequences_; }

  const std::vector<sequence>& get_true_sequences() const { return true_sequences_; }

  //! get nemo sequences
  std::vector<sequence>& get_nemo_sequences() { return nemo_sequences_; }

  const std::vector<sequence>& get_nemo_sequences() const { return nemo_sequences_; }
  //! get selected

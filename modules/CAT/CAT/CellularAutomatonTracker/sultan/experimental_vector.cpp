...
experimental_double experimental_vector::distance(const experimental_vector& p2) const {
  ...
  result.set_error(
      std::sqrt(pow(x_.value() * x_.error(), 2) + pow(p2.x().value() * p2.x().error(), 2) +
                pow(y_.value() * y_.error(), 2) + pow(p2.y().value() * p2.y().error(), 2) +
                pow(z_.value() * z_.error(), 2) + pow(p2.z().value() * p2.z().error(), 2)) /
      result.value());
...
experimental_double experimental_vector::length() const {
  ...
  result.set_value(std::sqrt(pow(x_.value(), 2) + pow(y_.value(), 2) + pow(z_.value(), 2)));
  result.set_error(std::sqrt(pow(x_.value() * x_.error(), 2) + pow(y_.value() * y_.error(), 2) +
                             pow(z_.value() * z_.error(), 2)) /
                   result.value());
...
experimental_double experimental_vector::phi() const { return experimental_atan2(y_, x_); }
...
experimental_double experimental_vector::kink_phi(const experimental_vector& v) {
  ...
  result.set_error(std::sqrt(pow(p1.error(), 2) + pow(p2.error(), 2)));
...
experimental_double experimental_vector::kink_theta(const experimental_vector& v) {
  ...
  result.set_error(std::sqrt(pow(t1.error(), 2) + pow(t2.error(), 2)));

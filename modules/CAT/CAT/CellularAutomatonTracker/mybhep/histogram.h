...
class Histogram : protected HistogramData {
 ...
 public:
  Histogram();
  Histogram(int, const std::vector<int>&, const std::vector<double>&, const std::vector<double>&,
            bool = false);
  Histogram(int, const std::vector<std::vector<double> >&, bool = false);
 ...
 protected:
  bool configure(int, const std::vector<int>&, const std::vector<double>&,
                 const std::vector<double>&, bool = false);
  bool configure(int, const std::vector<std::vector<double> >&, bool = false);
...
class Base2D : public Histogram {
 ...
 public:
  Base2D(const std::string&, int, double, double, int, double, double, bool = false);
  Base2D(const std::string&, const std::vector<double>&, const std::vector<double>&, bool = false);
  Base2D(const Base2D&);
  virtual ~Base2D();
...
class Histogram2D : public Base2D {
 ...
 public:
  Histogram2D(const std::string&, int, double, double, int, double, double);
  Histogram2D(const std::string&, const std::vector<double>&, const std::vector<double>&);
...
class Profile2D : public Base2D {
 ...
 public:
  Profile2D(const std::string&, int, double, double, int, double, double);
  Profile2D(const std::string&, int, double, double, int, double, double, double, double);
  Profile2D(const std::string&, const std::vector<double>&, const std::vector<double>&);
  Profile2D(const std::string&, const std::vector<double>&, const std::vector<double>&, double,
            double);
...
class Base3D : public Histogram {
 ...
 public:
  Base3D(const std::string&, int, double, double, int, double, double, int, double, double);
  Base3D(const std::string&, const std::vector<double>&, const std::vector<double>&,
...
class Histogram3D : public Base3D {
 ...
 public:
  Histogram3D(const std::string&, int, double, double, int, double, double, int, double, double);
  Histogram3D(const std::string&, const std::vector<double>&, const std::vector<double>&,
              const std::vector<double>&);
...
//////////////////////////////////////////////////////////////////////////////
inline bool HCL::Histogram::isOut(int aOffset) const
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  int iaxis;
...
//////////////////////////////////////////////////////////////////////////////
inline int HCL::Histogram::getOffset(const std::vector<int>& aIs) const
//////////////////////////////////////////////////////////////////////////////

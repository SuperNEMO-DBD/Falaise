...
const std::string& sultan_tracker_clustering_module::get_cd_label() const { return _CD_label_; }
...
const std::string& sultan_tracker_clustering_module::get_tcd_label() const { return _TCD_label_; }

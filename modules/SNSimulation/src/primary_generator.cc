...
void primary_generator::_check() {
  if (has_vertex_generator()) {
    if (!_vertex_generator_->is_initialized()) {
      G4Exception("mctools::g4::primary_generator::_check", "InitializationError", RunMustBeAborted,
...
void primary_generator::initialize(const datatools::properties& config_) {
  if (is_initialized()) {
    G4Exception("mctools::g4::primary_generator::initialize", "InitializationError",
                RunMustBeAborted, "Primary_Generator already initialized !");
  }
  ...
  if (_run_action_ == nullptr) {
    G4Exception("mctools::g4::primary_generator::initialize", "InitializationError",
                RunMustBeAborted, "Missing run action !");
  }
  ...
  if (_event_action_ == nullptr) {
    G4Exception("mctools::g4::primary_generator::initialize", "InitializationError",
                RunMustBeAborted, "Missing event action !");
  }
  if (_event_generator_ == nullptr) {
    G4Exception("mctools::g4::primary_generator::initialize", "InitializationError",
                RunMustBeAborted, "Missing event generator !");
  }
...
void primary_generator::reset() {
  if (!is_initialized()) {
    G4Exception("mctools::g4::primary_generator::reset", "InitializationError", FatalException,
...
void primary_generator::GeneratePrimaries(G4Event* g4_event_) {
  if (!is_initialized()) {
    G4Exception("mctools::g4::primary_generator::GeneratePrimaries", "InitializationError",
  ...
  for (auto i = current_generated_event.get_particles().begin();
    ...
    if (genbb_particle.has_pdg_code()) {
      ...
      if (g4_particle == nullptr) {
        ...
        G4Exception("mctools::g4::primary_generator::_generate_event", "InvalidArgument",

...
void particles_physics_constructor::tree_dump(std::ostream& out_, const std::string& title_,
...
void particles_physics_constructor::_ConstructBaryons() {
  ...
  if (_use_bottom_baryons_) {
    ...
    DT_LOG_WARNING(_logprio(),
                   "Geant4 version " << G4VERSION_NUMBER << " does not support bottom baryons.");
#endif  // G4VERSION_NUMBER == 960
...
#else   // G4VERSION_NUMBER == 960
    DT_LOG_WARNING(_logprio(), "Geant4 version " << G4VERSION_NUMBER
...
DOCD_CLASS_IMPLEMENT_LOAD_BEGIN(mctools::g4::particles_physics_constructor, ocd_) {
  ...
  ocd_.set_class_documentation(
      "This is a very simple physics constructor that       \n"
...

  {
    ...
    cpd.set_name_pattern("use_geantinos")
        ...
        .add_example(
            "Activate the *geantinos* mock particles: :: \n"
            "                                            \n"
...

  {
    ...
    cpd.set_name_pattern("use_light_anti_nuclei")
        ...
        .set_default_value_boolean(false)
        .add_example(
            "Activate the *light* anti nuclei: :: \n"
            "                                     \n"

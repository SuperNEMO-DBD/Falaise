...
auto track_history::track_info::get_id() const -> int { return _id_; }

void track_history::track_info::set_id(const int id_) { _id_ = id_; }

auto track_history::track_info::get_parent_id() const -> int { return _parent_id_; }

void track_history::track_info::set_parent_id(const int id_) { _parent_id_ = id_; }

auto track_history::track_info::is_primary() const -> bool { return _parent_id_ == TRACK_ID_UNSET; }
...
track_history::track_info::track_info() { reset(); }
...
track_history::track_history() = default;

track_history::~track_history() { reset(); }

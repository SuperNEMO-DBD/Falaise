...
void base_physics_constructor::set_name(const std::string& name_) { _name_ = name_; }

auto base_physics_constructor::get_name() const -> const std::string& { return _name_; }

void base_physics_constructor::set_class_id(const std::string& class_id_) {
  _class_id_ = class_id_;
}

auto base_physics_constructor::get_class_id() const -> const std::string& { return _class_id_; }
...
void base_physics_constructor::_set_initialized(bool i) { _initialized_ = i; }

void base_physics_constructor::_set_mother_physics_list(physics_list& mother_) {
  _mother_physics_list_ = &mother_;
}

void base_physics_constructor::tree_dump(std::ostream& out_, const std::string& title_,
  ...
  out_ << indent_ << datatools::i_tree_dumpable::tag << "Class ID              : '" << _class_id_
       << "'" << std::endl;

...
calo_hit_reader::calo_hit_reader() { return; }
...
const std::string& calo_hit_reader::get_input_filename() const { return _input_filename_; }
...
datatools::logger::priority calo_hit_reader::get_logging() const { return _logging_; }
...
bool calo_hit_reader::is_initialized() const { return _initialized_; }

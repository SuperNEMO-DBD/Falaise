...
calo_hit_parser::calo_hit_parser() { return; }
...
void calo_hit_parser::_parse_header_(const std::string& header_line_, const int index_,
                                     calo_hit& hit_) {
  DT_LOG_TRACE_ENTERING(logging);
  ...
  if (index_ == 0) {
    ...
    res = qi::phrase_parse(
        ...
        (qi::lit("Slot") >> qi::uint_[boost::phoenix::ref(slotid) = boost::spirit::qi::_1] >>
         ...
         qi::lit("TrigCount") >>
         qi::uint_[boost::phoenix::ref(trigcount) = boost::spirit::qi::_1] >>
         qi::lit("Timecount") >>
         qi::ulong_long[boost::phoenix::ref(timecount) = boost::spirit::qi::_1] >>
         qi::lit("RawBaseline") >>
         qi::int_[boost::phoenix::ref(rawbaseline) = boost::spirit::qi::_1] >>
         qi::lit("Baseline") >>
         qi::double_[boost::phoenix::ref(baseline_volt) = boost::spirit::qi::_1] >>
         ...
         qi::lit("Charge") >>
         qi::double_[boost::phoenix::ref(charge_picocoulomb) = boost::spirit::qi::_1] >>
         qi::lit("Overflow") >> qi::uint_[boost::phoenix::ref(overflow) = boost::spirit::qi::_1] >>
         qi::lit("RisingCell") >>
         qi::uint_[boost::phoenix::ref(risingcell) = boost::spirit::qi::_1] >>
         qi::lit("RisingOffset") >>
         qi::uint_[boost::phoenix::ref(risingoffset) = boost::spirit::qi::_1] >>
         qi::lit("RisingTime") >>
         qi::double_[boost::phoenix::ref(rising_ns) = boost::spirit::qi::_1] >>
         qi::lit("FallingCell") >>
         qi::uint_[boost::phoenix::ref(fallingcell) = boost::spirit::qi::_1] >>
         qi::lit("FallingOffset") >>
         qi::uint_[boost::phoenix::ref(fallingoffset) = boost::spirit::qi::_1] >>
         qi::lit("FallingTime") >>
         qi::double_[boost::phoenix::ref(falling_ns) = boost::spirit::qi::_1] >> qi::lit("FCR") >>
         qi::uint_[boost::phoenix::ref(fcr) = boost::spirit::qi::_1]),
        //  End grammar
        qi::space);
    DT_THROW_IF(
        !res || str_iter != end_iter, std::logic_error,
    ...
    if (lto_flag != 0)
      hit_.low_threshold = true;
    else
      hit_.low_threshold = false;
    if (ht_flag != 0)
      hit_.high_threshold = true;
    else
      hit_.high_threshold = false;
...
void calo_hit_parser::_parse_samples_(const std::string& data_line_, calo_hit& hit_) {
  DT_LOG_TRACE_ENTERING(logging);
  ...
  //     std::size_t waveform_data_size = 0; // unknown from the header !!! so we let Spirit guess
  //     it...
  bool res = false;
  res = qi::phrase_parse(str_iter, end_iter,
                         ...
                         (
                             ...
                             +qi::int_),
                         //  End grammar
                         qi::space, raw_waveform_data);
  DT_THROW_IF(!res || str_iter != end_iter, std::logic_error, "Cannot parse event samples!");

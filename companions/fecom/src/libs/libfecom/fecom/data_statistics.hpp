...
struct data_statistics : public datatools::i_serializable, public datatools::i_tree_dumpable {
 ...
 public:
  ...
  std::pair<double, std::size_t>
      mean_number_of_calo_ht;  // pair <mean_number_of_calo_ht, counter_calo_HT>
  ...
  std::array<register_for_cell, fecom::tracker_constants::NUMBER_OF_LAYERS>
      cell_registers_if_calo_tracker;
  ...
  // Calorimeter :
  std::array<TH1F *, fecom::calo_constants::NUMBERS_OF_CALO_PER_COLUMN>
      charge_picocoulomb_calo_TH1F;
  std::array<TH1F *, fecom::calo_constants::NUMBERS_OF_CALO_PER_COLUMN>
      charge_picocoulomb_ht_calo_TH1F;
  std::array<TH1F *, fecom::calo_constants::NUMBERS_OF_CALO_PER_COLUMN>
      charge_picocoulomb_no_ht_calo_TH1F;
...
BOOST_CLASS_EXPORT_KEY2(fecom::data_statistics, "fecom::data_statistics")

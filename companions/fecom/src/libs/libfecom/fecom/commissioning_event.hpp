...
//! \brief Commissioning event, contain a collection of calo_hits and tracker_channel_hits and can
//! build associated tracker hits from channels
struct commissioning_event : public datatools::i_serializable, public datatools::i_tree_dumpable {
  ...
  struct compare {
    bool operator()(const commissioning_event& a, const commissioning_event& b);
  };

  typedef std::set<fecom::calo_hit, fecom::base_hit::compare> calo_hit_collection;
  typedef std::set<fecom::tracker_channel_hit, fecom::base_hit::compare>
      tracker_channel_hit_collection;
  ...
  const commissioning_event::tracker_channel_hit_collection& get_tracker_channel_hit_collection()
      const;
  ...
  */
  ...
  tracker_channel_hit_collection
      _tracker_channel_hit_collection_;             ///< Tracker hit collection for a trigger id
...
BOOST_CLASS_EXPORT_KEY2(fecom::commissioning_event, "fecom::commissioning_event")

...
namespace fecom {
  ...
  const std::string & hit_reader::get_input_filename() const
  {
  ...
  datatools::logger::priority hit_reader::get_logging() const
  {
    return _logging_;
  }
  ...
  bool hit_reader::is_initialized() const
  {

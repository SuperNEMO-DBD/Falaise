...
namespace fecom {
  ...
  double calo_constants::adc_dynamics()
  {
    return 2.5 * CLHEP::volt;
  }

  double calo_constants::adc_unit()
  {
    return adc_dynamics() / 4096;
  }

  double calo_constants::adc_offset_unit()
  {
    return adc_unit() / 16;
  }

  double calo_constants::default_sampling_frequency()
  {
  ...
  double calo_constants::time_offset_unit()
  {

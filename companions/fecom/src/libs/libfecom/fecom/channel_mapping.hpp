...
class channel_mapping {
 public:
  ...
  void get_cell_layer_row_for_a_channel(const geomtools::geom_id& electronic_id_,
                                        uint16_t& layer_number_, uint16_t& row_number_) const;

  /// Get the electronics ID associated to a cell (layer, row)
  void get_electronics_id_for_a_cell_layer_row(
  ...
  /// Given an electronic for the tracker, return the anodic, bottom cathodic and top cathodic
  /// associated ID

...
namespace FLReconstruct {
  ...
  FLReconstructParams FLReconstructParams::makeDefault()
  {
    ...
    params.reconstructionSetupUrn = "";  // "urn:snemo:demonstrator:reconstruction:3.0" snemo::processing::default_reconstruction_tag()
    params.reconstructionPipelineUrn = "";  // "urn:snemo:demonstrator:reconstruction:3.0:pipeline:official-3.0"

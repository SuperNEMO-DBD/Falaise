...
[document](FLSimulateVariantsDoc-2.1.pdf). It  describes all available
simulation  variant  parameters  and their  possible  dependencies for
SuperNEMO simulation version 2.1.
...
#@description Name of detector to simulate (default="demonstrator")
experimentID      : string = "demonstrator"
#@description Version of the simulation setup (default="2.1")
simulationVersion : string = "2.1"
...
helps to generated such lists of seed sets.


Note the *VariantSubsystem* here uses an explicit list of *settings*
for some variant parameters. It is possible to use a variant profile
file in place of it:
...
generator  are sensible.  Other invalid  options (geometry...)  should
also be reported.
